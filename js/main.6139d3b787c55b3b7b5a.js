...
const Banner = ({ small, description, title, children, leftChildren, ...props }) => (react_1.default.createElement(components_1.Flexbox, { ...props, height: small ? '20rem' : '40rem', backgroundColor: "background-color-01" },
    react_1.default.createElement(Description, { fullWidth: !children },
        title,
        description && (react_1.default.createElement(components_1.Text, { marginY: "m-size", type: "body-2" }, description)),
        leftChildren),
...
const Home = () => {
    ...
    (0, hooks_1.useScrollTop)();
    return (react_1.default.createElement(components_1.Page, null,
        react_1.default.createElement(components_1.BannerWithPicture, { img: banner_guy_png_1.default, description: t('banner.description'), title: react_1.default.createElement(components_1.Heading, { level: 4 },
                react_1.default.createElement("strong", null, "See"),
                "\u00A0everything with\u00A0",
                react_1.default.createElement("strong", null, "Clarity")) },
            react_1.default.createElement(components_1.Button, { onClick: () => history.push(routes_1.PRODUCTS), icon: "arrow-right" }, t('banner.buttonLabel'))),
...
/******/ })()
;
//# sourceMappingURL=main.6139d3b787c55b3b7b5a.js.map