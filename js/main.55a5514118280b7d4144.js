            ...
            if (isInBasket) {
                return {
                    ...
                    total: {
                        ...
                        sum: (0, lodash_subtract_1.default)(prev.total.sum, product.price)
                    }
                };
            }
            return {
                ...
                total: {
                    ...
                    sum: (0, lodash_add_1.default)(prev.total.sum, product.price)
                }
            };
        });
    };
...
/******/ })()
;
//# sourceMappingURL=main.55a5514118280b7d4144.js.map