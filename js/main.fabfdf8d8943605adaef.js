...
const getOrders = async (type) => {
    ...
    let q = (0, firestore_1.query)(ref, (0, firestore_1.orderBy)('modifiedAt'));
    if (type) {
        q = (0, firestore_1.query)(ref, (0, firestore_1.where)('status', '==', type), (0, firestore_1.orderBy)('modifiedAt'));
    }
    const snapshot = await (0, firestore_1.getDocs)(q);
    const orders = (0, utils_1.getCollection)(snapshot, models_1.order);
    return orders;
};
const useGetOrders = (type) => {
    const queryKey = type ? `orders/${type}` : 'orders';
    return (0, react_query_1.useQuery)(queryKey, () => getOrders(type));
};
...
const react_1 = __importDefault(__webpack_require__(67294));
const Tile = ({ children, ...props }) => (react_1.default.createElement(Flexbox_1.default, { width: "100%", padding: "30px", background: "white", border: "1px solid", borderColor: "border-color", flexDirection: "column", ...props }, children));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Tile = exports.Button = exports.CheckboxField = exports.Square = exports.Flexbox = exports.Separator = exports.Badge = exports.QueryLoader = exports.Box = exports.Page = void 0;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ADMIN_ORDERS = exports.CHECKOUT_RESULT = exports.CHECKOUT_PAYMENT = exports.CHECKOUT_SHIPPING = exports.CHECKOUT_DELIVERY = exports.CHECKOUT_DETAILS = exports.CHECKOUT_PRODUCTS = exports.VIEW_PRODUCT = exports.PRODUCTS = void 0;
...
const pl = {
    ...
    adminOrders: {
        ...
        tableTitles: {
            open: 'Otwarte',
            paymentReceived: 'Zapłacone',
            inPreparation: 'W przygtowaniu',
            awaitingForPickup: 'Oczekują na kuriera',
...
const prop_types_1 = __importDefault(__webpack_require__(45697));
const react_1 = __importStar(__webpack_require__(67294));
const react_redux_1 = __webpack_require__(28216);
const react_router_dom_1 = __webpack_require__(77856);
        ...
        react_1.default.createElement("div", { className: "searchbar", ref: searchbarRef },
            ...
            filter.recent.length !== 0 && (react_1.default.createElement("div", { className: "searchbar-recent" },
                ...
                filter.recent.map((item, index) => (react_1.default.createElement("div", { className: "searchbar-recent-wrapper", key: `search-${item}-${index}` },
                    ...
                    react_1.default.createElement("span", { className: "searchbar-recent-button text-subtle", onClick: () => undefined, role: "presentation" }, "X")))))))));
};
...
const react_1 = __importDefault(__webpack_require__(67294));
const utils_1 = __webpack_require__(49502);
const Row = ({ order }) => (react_1.default.createElement(components_1.Box, { as: "tr", height: "6rem" },
    react_1.default.createElement("td", null, order.id),
    react_1.default.createElement("td", null, (0, utils_1.displayDate)(new firestore_1.Timestamp(order.modifiedAt.seconds, order.modifiedAt.nanoseconds))),
    react_1.default.createElement("td", null, (0, utils_1.displayDate)(new firestore_1.Timestamp(order.createdAt.seconds, order.createdAt.nanoseconds))),
...
const Table = ({ type }) => {
    ...
    const ordersQuery = (0, getOrders_1.useGetOrders)(type);
    return (react_1.default.createElement(components_1.QueryLoader, { query: ordersQuery }, (orders) => (react_1.default.createElement(components_1.Box, { as: "table", width: "100%", border: "1px solid", borderColor: "border-color" },
        ...
        react_1.default.createElement("tbody", null,
            orders.map((order) => (react_1.default.createElement(Row_1.default, { key: order.id, order: order }))),
...
const AdminOrders = () => {
    const { t } = (0, react_i18next_1.useTranslation)('adminOrders');
    return (react_1.default.createElement(components_1.Page, null, tables.map((table, index) => (react_1.default.createElement(components_1.Tile, { key: table.type, marginTop: index === 0 ? 0 : '3rem' },
        react_1.default.createElement(TableTitle, null, t(`tableTitles.${table.title}`)),
        react_1.default.createElement(Table_1.default, { type: table.type }))))));
};
...
const tables = [
    ...
    {
        title: 'awaitingForPickup',
        type: 'AWAITING_FOR_PICKUP'
    },
    {
        title: 'inDelivery',
        type: 'IN_DELIVERY'
...
const api_1 = __webpack_require__(72934);
const BasketProvider_1 = __webpack_require__(81400);
const triggerNewOrder_1 = __importDefault(__webpack_require__(47700));
const firestore_1 = __webpack_require__(84956);
const useFormSubmit = () => {
    const history = (0, react_router_dom_1.useHistory)();
    const { t } = (0, react_i18next_1.useTranslation)('checkout');
    ...
    const { mutateAsync: mutateTriggerNewOrder } = (0, react_query_1.useMutation)(triggerNewOrder_1.default);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.AdminOrders = exports.CheckoutResult = exports.CheckoutShipping = exports.CheckoutPayment = exports.CheckoutDelivery = exports.CheckoutDetails = exports.CheckoutProducts = exports.ViewProduct = exports.PageNotFound = exports.App = exports.Products = void 0;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.RemoteConfigProvider = exports.BasketProvider = exports.CheckoutProvider = exports.BasketToggleProvider = void 0;
...
const format_1 = __importDefault(__webpack_require__(22605));
const displayDate = (timestamp) => {
    const date = timestamp.toDate();
    return (0, format_1.default)(date, 'HH:mm dd/MM/yyyy');
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.displayDate = exports.displayMoney = exports.calculateTotal = exports.getCollection = exports.parseApiResponse = void 0;
...
/******/ })()
;
//# sourceMappingURL=main.fabfdf8d8943605adaef.js.map