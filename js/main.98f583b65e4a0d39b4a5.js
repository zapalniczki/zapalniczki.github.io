...
const useGetMolds = () => {
    return (0, react_query_1.useQuery)(exports.getMoldsQueryKey, () => getMolds());
};
...
const getProducts = async (payload) => {
    ...
    if (payload?.title) {
        q = (0, firestore_1.query)(ref, (0, firestore_1.where)('title', '==', payload.title));
    }
    if (payload?.title && payload?.icon && payload.otherVariants) {
        q = (0, firestore_1.query)(ref, (0, firestore_1.where)('title', '==', payload.title), (0, firestore_1.where)('icon', '!=', payload.icon));
    }
    if (payload?.name) {
        q = (0, firestore_1.query)(ref, (0, firestore_1.where)('name', '==', payload.name));
    }
    const snapshot = await (0, firestore_1.getDocs)(q);
...
const useGetProducts = (payload) => {
    ...
    if (payload?.tag) {
        queryKey += `tag=${payload.tag}`;
    }
    if (payload?.title) {
        queryKey += `title=${payload.title}`;
    }
    if (payload?.icon) {
        queryKey += `icon=${payload.icon}`;
    }
    if (payload?.name) {
        queryKey += `name=${payload.name}`;
    }
    return (0, react_query_1.useQuery)(queryKey, () => getProducts(payload));
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getMolds = exports.triggerNewOrder = exports.getOrderStatus = exports.updateOrderStatus = exports.getOrders = exports.addOrder = exports.getProduct = exports.getProducts = void 0;
...
const pl = {
    ...
    PRODUCTS: {
        ...
        searchPlaceholder: 'Zacznij wpisywać, żeby wyszukać'
    },
    PAGE_NOT_FOUND: {
        title: '404 ',
    ...
    TERMS_AND_CONDITIONS: {
        title: 'Regulamin',
        linkLabel: 'Aktualną wersję dokumentu'
    },
    PRIVACY_POLICY: {
        ...
        react_1.default.createElement(QueryLoader_1.default, { query: productQuery }, (product) => {
            ...
            return (react_1.default.createElement(react_1.default.Fragment, null,
                ...
                react_1.default.createElement(components_1.Box, { gridArea: "picture", position: "relative", width: "9rem", height: "9rem" },
                    react_1.default.createElement(components_1.ImageLoader, { alt: product.name, src: thumbnail })),
                react_1.default.createElement(components_1.Flexbox, { flexDirection: "column", gridArea: "name" },
                    ...
                    variantName && (react_1.default.createElement(components_1.Box, { as: "span", marginTop: "xs-size", fontSize: "font-small" }, variantName))),
                react_1.default.createElement(components_1.Flexbox, { alignItems: "center" },
                    react_1.default.createElement(components_1.Box, { as: "h4", margin: "0" }, (0, utils_1.displayMoney)(product.price))),
...
const Container = (0, styled_components_1.default)(components_1.Tile) `
  ...
  display: grid;
  grid-template-columns: max-content 2rem 9rem auto max-content;
...
const Header = () => {
    ...
    return (react_1.default.createElement(components_1.Flexbox, { padding: "m-size", width: "100%", backgroundColor: "white", 
        ...
        !!basketLength && (react_1.default.createElement(components_1.Button, { marginRight: "s-size", size: "small", variant: "secondary", onClick: clearBasket, type: "button" }, t('basket.clear'))),
...
const ProductTile = ({ product }) => {
    ...
    return (react_1.default.createElement(Container, { padding: 0, "max-height": "30rem", onClick: () => history.push(viewProductPath) },
        react_1.default.createElement(ImageWrapper, null,
            react_1.default.createElement(components_1.ImageLoader, { alt: "", src: product.gallery[0].url })),
...
const ProductsList = ({ searchQuery, link, title, query, ...props }) => (react_1.default.createElement(components_1.Flexbox, { flexDirection: "column", as: "section", ...props },
    react_1.default.createElement(components_1.SectionHead, { title: title, link: link }),
    react_1.default.createElement(components_1.QueryLoader, { query: query }, (products) => (react_1.default.createElement(components_1.Grid, null, products
        .filter((product) => product.name
        .toLowerCase()
        .includes(searchQuery?.toLowerCase() ?? product.name))
        .map((product) => (react_1.default.createElement(Tile_1.default, { key: product.id, product: product }))))))));
...
const LongProductTile = ({ product, ...props }) => {
    const history = (0, react_router_dom_1.useHistory)();
    const imageUrl = product.gallery[0]?.url;
...
const styled_components_1 = __importDefault(__webpack_require__(91288));
const MobileInput = ({ placeholder, defaultValue, label, disabled, name }) => {
    ...
    return (react_1.default.createElement(Flexbox_1.default, { flexDirection: "column" },
        touched && error ? (react_1.default.createElement(components_1.InputLabel, { error: true }, error?.value || error?.dialCode)) : (react_1.default.createElement(components_1.InputLabel, { htmlFor: field.name }, label)),
        react_1.default.createElement(StyledPhoneInput, { isError: !!touched && !!error, disabled: disabled, country: "pl", inputClass: "input-form d-block", onChange: handleChange, placeholder: placeholder, disableDropdown: true, countryCodeEditable: false, value: defaultValue?.value ?? '', masks: { pl: '... .. .. ..' } })));
};
...
const Box_1 = __importDefault(__webpack_require__(84962));
const react_1 = __importDefault(__webpack_require__(67294));
const Spinner = ({ small, ...props }) => (react_1.default.createElement(Box_1.default, { ...props },
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ExternalLink = exports.TitleAndLinkBanner = exports.Link = exports.InputLabel = exports.MobileInput = exports.Logo = exports.Input = exports.Spinner = exports.Banner = exports.Grid = exports.SectionHead = exports.ImageLoader = exports.LongProductTile = exports.Select = exports.Tile = exports.Button = exports.CheckboxField = exports.Square = exports.Flexbox = exports.Separator = exports.Badge = exports.QueryLoader = exports.Box = exports.Page = void 0;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.timestampDate = exports.mold = exports.order = exports.basketItem = exports.product = void 0;
...
const icon = (0, zod_1.enum)(['HEART', 'BOAT', 'ANCHOR', 'TODO']);
const title = (0, zod_1.string)();
const collection = (0, zod_1.enum)(['PLACES', 'POLAND']);
const product = (0, zod_1.object)({
    id: (0, zod_1.string)(),
    dateAdded: timestampDate_1.default,
...
const date_fns_1 = __webpack_require__(46609);
...
const useOrderInfo = (order) => {
    ...
    return {
        ...
        molds: (0, lodash_uniq_1.default)(order.products?.map((product) => {
            ...
            let displayName = mold.productId;
            if (mold.variant) {
                displayName = mold.productId + '/' + mold.variant;
            }
            let status = null;
            if (moldsData) {
                const alfa = moldsData.find((dbMold) => {
                    if (mold.variant) {
                        return (dbMold.productId === mold.productId &&
                            dbMold.variant === mold.variant);
                    }
                    return dbMold.productId === mold.productId;
                });
...
const Search = ({ value, onChange }) => {
    ...
    return (react_1.default.createElement(components_1.Flexbox, { position: "relative", width: "50%" },
...
const Products = () => {
    ...
    const count = productQuery.data?.length;
    return (react_1.default.createElement(components_1.Page, null,
        state?.title && react_1.default.createElement(BackButton_1.default, { to: routes_1.PRODUCTS, label: t('showAllLabel') }),
        react_1.default.createElement(components_1.Flexbox, { justifyContent: "space-between", alignItems: "center" },
            react_1.default.createElement(components_1.Box, { as: "h3", margin: "0", width: "max-width", marginRight: "m-size" }, loaded &&
                (count === 1
        ...
        react_1.default.createElement(commonComponents_1.ProductsGrid, { searchQuery: query, marginTop: "l-size", query: productQuery })));
};
...
const Images = ({ product, variant }) => {
    ...
    return (react_1.default.createElement(components_1.Flexbox, { flexGrow: 4, flexDirection: "column", minWidth: width, maxWidth: width },
        react_1.default.createElement(components_1.Square, { display: "flex" },
            gallery.length > 0 && (react_1.default.createElement(components_1.Flexbox, { flexDirection: "column", width: "6rem", height: "100%" }, gallery.map((image) => (react_1.default.createElement(GalleryImageWrapper, { key: image.id, onClick: () => setSelectedImage(image.url), role: "presentation" },
                react_1.default.createElement(components_2.ImageLoader, { src: image.url })))))),
            react_1.default.createElement(ImageWrapper, null,
        ...
        return (react_1.default.createElement(formik_1.Form, null,
            react_1.default.createElement(formik_1.Field, { name: "variant" }, (fieldProps) => (react_1.default.createElement(react_1.default.Fragment, null,
                ...
                react_1.default.createElement(components_1.Select, { placeholder: t('selectPlaceholder'), onChange: (option) => {
                    ...
                    }, options: sortAndMapOptions(variants) })))),
...
const OtherIcons_1 = __importDefault(__webpack_require__(38031));
const routes_1 = __webpack_require__(74897);
const ViewProduct = () => {
    ...
    (0, hooks_1.useDocumentTitle)(t('title', { productName: productQuery.data?.name }));
    ...
    return (react_1.default.createElement(components_1.Page, null,
        react_1.default.createElement(components_1.QueryLoader, { query: productQuery }, (product) => {
            ...
            if (product.type === 'CUSTOM') {
                form = react_1.default.createElement(CustomType_1.default, { product: product });
            }
            return (react_1.default.createElement(react_1.default.Fragment, null,
                ...
                react_1.default.createElement(components_1.Tile, { flexDirection: "row" },
                    ...
                    react_1.default.createElement(components_1.Flexbox, { flexGrow: 1, flexDirection: "column", marginLeft: "xl-size" },
                        ...
                        react_1.default.createElement(components_1.Box, { as: "h4", margin: 0, marginTop: "s-size", color: "gray-10" }, t('priceSubtitle')),
                        react_1.default.createElement(components_1.Separator, null),
                        react_1.default.createElement(components_1.Box, { as: "p", margin: 0 }, product.description),
                        react_1.default.createElement(components_1.Separator, null),
                        form))));
        }),
        productQuery.isFetched && (react_1.default.createElement(OtherIcons_1.default, { title: productQuery.data?.title, icon: productQuery.data?.icon }))));
};
...
const useForm = () => {
    ...
    const schema = (0, yup_1.object)().shape({
        deliveryType: (0, yup_1.mixed)().oneOf(config_1.DELIVERY_METHODS.map((method) => method.name), t('validation.deliveryType.oneOf'))
    });
    return {
        onSubmitForm,
        initialValues,
...
const Form = ({ isIndividual }) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(Row_1.default, null,
            react_1.default.createElement(FieldWrapper_1.default, null,
                react_1.default.createElement(formik_1.Field, { name: "fullname", type: "text" }, (props) => {
                    ...
                    return (react_1.default.createElement(components_1.Input, { ...props, label: (0, utils_1.getRequiredOrNot)(t(`form.${base}.label`), true), placeholder: t(`form.${base}.placeholder`) }));
                })),
        ...
        react_1.default.createElement(Row_1.default, null,
            ...
            react_1.default.createElement(FieldWrapper_1.default, null,
                react_1.default.createElement(formik_1.Field, { name: "mobile" }, (props) => (react_1.default.createElement(components_1.MobileInput, { label: (0, utils_1.getRequiredOrNot)(t('form.phone.label'), true), fieldProps: props, name: "mobile", defaultValue: values['mobile'] })))))));
};
exports["default"] = Form;
    ...
    return (react_1.default.createElement(components_1.Page, null,
        ...
        react_1.default.createElement(common_1.Wrapper, null,
            ...
            react_1.default.createElement(Flexbox_1.default, { marginBottom: "m-size", justifyContent: "center", alignItems: "center" },
                react_1.default.createElement(CustomTypeButton, { onClick: () => setIsIndividual(false) }, commonT('customerTypes.COMPANY')),
                ...
                react_1.default.createElement(CustomTypeButton, { onClick: () => setIsIndividual(true) }, commonT('customerTypes.INDIVIDUAL'))),
...
const useForm = () => {
    ...
    const getSchema = (isIndividual) => {
        const base = (0, yup_1.object)().shape({
            fullname: (0, yup_1.string)().required(t(`validations.${isIndividual ? 'name' : 'company'}.required`)),
            email: (0, yup_1.string)()
                .email(t('validations.email.email'))
            ...
            mobile: (0, yup_1.object)()
                ...
                value: (0, yup_1.string)()
                    .min(11, t('validations.mobile.min'))
                    .required(t('validations.mobile.required'))
            })
                .required(t('validations.mobile.required')),
            street: (0, yup_1.string)().required(t('validations.street.required')),
            postCode: (0, yup_1.string)()
                .trim()
                .matches(/^(\d{2})-(\d{3})$/, t('validations.postCode.matches'))
                .required(t('validations.postCode.required')),
            city: (0, yup_1.string)().required(t('validations.city.required'))
        });
        const companySchema = base.shape({
            nip: (0, yup_1.string)()
                .required(t('validations.nip.required'))
                .length(10, t('validations.nip.length'))
                .matches(/^(\d{10})$/, t('validations.nip.matches'))
        });
...
const useFormSubmit = () => {
    ...
    const schema = (0, yup_1.object)().shape({
        paymentType: (0, yup_1.mixed)().oneOf([...config_1.PAYMENT_METHODS], t('validation.paymentType.oneOf'))
    });
    return {
        onSubmit,
        initialValues,
...
const useForm = () => {
    ...
    const schema = (0, yup_1.object)().shape({
        street: (0, yup_1.string)().required(t('validation.street.required')),
        postCode: (0, yup_1.string)()
            .trim()
            .matches(/^(\d{2})-(\d{3})$/, t('validation.postCode.matches'))
            .required(t('validation.postCode.required')),
        city: (0, yup_1.string)().required(t('validation.city.required'))
    });
    return {
        onSubmitForm,
        initialValues,
...
const Actions = ({ primaryDisabled }) => {
    ...
    return (react_1.default.createElement(Flexbox_1.default, { marginTop: "3rem", alignItems: "center", justifyContent: "space-between" },
        ...
        react_1.default.createElement(components_1.Button, { disabled: isBasketEmpty || primaryDisabled, onClick: onClickNext, type: isFirstPage ? 'button' : 'submit' },
            react_1.default.createElement(Box_1.default, { marginRight: "s-size" }, t(current === 4
...
/******/ })()
;
//# sourceMappingURL=main.98f583b65e4a0d39b4a5.js.map