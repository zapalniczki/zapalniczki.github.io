...
const CheckoutDetails = () => {
    ...
    (0, hooks_1.useScrollTop)();
    const [customerType, setCustomerType] = (0, react_1.useState)('COMPANY');
...
const CheckoutPayment = () => {
    ...
    (0, hooks_1.useScrollTop)();
    const { onSubmit, initialValues, schema } = (0, useForm_1.default)();
    // if (!deliveryType) {
...
const CheckoutShipping = () => {
    ...
    return (react_1.default.createElement(components_1.Page, null,
        ...
        react_1.default.createElement(common_1.Wrapper, null,
            ...
            react_1.default.createElement(formik_1.Formik, { initialValues: initialValues, validateOnChange: true, validationSchema: schema, onSubmit: onSubmitForm }, ({ handleSubmit }) => (
            // const delivery = DELIVERY_METHODS.FREE_PARCEL
            react_1.default.createElement(formik_1.Form, { onSubmit: handleSubmit },
                react_1.default.createElement(Form_1.default, null),
                react_1.default.createElement(common_1.Actions, null)))))));
};
...
const StepTracker = () => {
    ...
    return (react_1.default.createElement(components_1.Flexbox, { justifyContent: "center", marginBottom: "3rem" },
        react_1.default.createElement(Wrapper, null, [1, 2, 3, 5].map((step) => (react_1.default.createElement("li", { key: step, className: `checkout-header-list ${getClassName(current, step)}` },
...
`;
const getClassName = (current, step) => current === step ? 'is-active-step' : step < current ? 'is-done-step' : '';
...
const Total = ({ customProducts, customDelivery }) => {
    ...
    const sum = (products * 100 + delivery * 100) / 100;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.checkoutContext = void 0;
const react_1 = __webpack_require__(67294);
...
const CheckoutProvider = ({ children }) => {
    const [checkout, setCheckout] = (0, react_1.useState)(initState);
...
/******/ })()
;
//# sourceMappingURL=main.74f226c052b32da58be5.js.map