...
const useUpdateOrderStatus = (order, currentStatus) => {
    const { hide, show } = (0, react_1.useContext)(providers_1.loaderContext);
...
const providers_2 = __webpack_require__(7539);
...
const providers_3 = __webpack_require__(7539);
const lodash_subtract_1 = __importDefault(__webpack_require__(81057));
const BasketItem = ({ product: basketProduct }) => {
    const { setBasket } = (0, react_1.useContext)(providers_1.basketContext);
    const { closeBasket } = (0, react_1.useContext)(providers_2.basketToggleContext);
    const { setCheckout } = (0, react_1.useContext)(providers_3.checkoutContext);
...
const Checkout = () => {
    ...
    const { basket, basketLength } = (0, react_1.useContext)(providers_1.basketContext);
    const { closeBasket } = (0, react_1.useContext)(providers_2.basketToggleContext);
    const { setCheckout } = (0, react_1.useContext)(providers_3.checkoutContext);
...
const Header = () => {
    const { t } = (0, hooks_1.useTranslation)('COMMON');
    const { closeBasket } = (0, react_1.useContext)(providers_2.basketToggleContext);
    const { basketLength, clearBasket } = (0, react_1.useContext)(providers_1.basketContext);
    const { setCheckout } = (0, react_1.useContext)(providers_3.checkoutContext);
...
const components_1 = __webpack_require__(82740);
const SimpleButton = ({ children, disabled, onClick, ...props }) => (react_1.default.createElement(components_1.Box, { ...props },
...
const Basket = () => {
    const { t } = (0, hooks_1.useTranslation)('COMMON');
    const { isOpen, setIsOpen } = (0, react_1.useContext)(providers_2.basketToggleContext);
    const { basket, basketLength } = (0, react_1.useContext)(providers_1.basketContext);
...
const Form = () => {
    ...
    return (react_1.default.createElement(components_1.Flexbox, { alignItems: "flex-end" },
        react_1.default.createElement(components_2.FieldWrapper, null,
...
const CallMeBack = (props) => {
    const { t: commonT } = (0, hooks_1.useTranslation)('COMMON');
    const { initialValues, onSubmit, schema, view } = (0, useForm_1.default)();
...
const BasketToggle = () => {
    const { pathname } = (0, react_router_dom_1.useLocation)();
    const { basket } = (0, react_1.useContext)(providers_1.basketContext);
    const { setIsOpen } = (0, react_1.useContext)(providers_2.basketToggleContext);
...
const Newsletter = () => {
    const { t: commonT } = (0, hooks_1.useTranslation)('COMMON');
    const { initialValues, onSubmit, schema, setView, view } = (0, useForm_1.default)();
    const { colors } = (0, styled_components_1.useTheme)();
...
const ProductTile = ({ product }) => {
    ...
    const { colors } = (0, styled_components_1.useTheme)();
    const { getProductFromBasket } = (0, react_1.useContext)(providers_1.basketContext);
...
const Container = (0, styled_components_1.default)(components_1.Tile) `
  ...
  ${components_1.ProductImageHover}
`;
...
const ProductsGridLoader = ({ count = 3, title, ...props }) => (react_1.default.createElement(components_1.Flexbox, { flexDirection: "column" },
...
exports["default"] = ProductsGridLoader;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ProductsGridLoader = void 0;
const components_1 = __webpack_require__(82740);
const react_1 = __importDefault(__webpack_require__(67294));
const index_loader_1 = __importDefault(__webpack_require__(95496));
exports.ProductsGridLoader = index_loader_1.default;
const ProductTile_1 = __importDefault(__webpack_require__(21741));
const ProductsList = ({ link, loaderCount, query, searchQuery, title, vertical, ...props }) => (react_1.default.createElement(components_1.QueryLoader, { Loader: react_1.default.createElement(index_loader_1.default, { count: loaderCount, title: !!title || !!link }), query: query }, (products) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ReadTermsAndConditions = exports.ReadPrivacyPolicy = exports.ProductsGrid = exports.Preloader = exports.Newsletter = exports.Navigation = exports.Footer = exports.Features = exports.CallMeBack = exports.Basket = void 0;
...
__exportStar(__webpack_require__(69462), exports);
...
const components_1 = __webpack_require__(82740);
const react_1 = __importDefault(__webpack_require__(67294));
const BackButton = ({ label, to, ...props }) => (react_1.default.createElement(components_1.Box, { paddingY: "xs-size", ...props },
...
const react_1 = __importDefault(__webpack_require__(67294));
const components_1 = __webpack_require__(82740);
const Banner = ({ background, children, description, horizonal, medium, small, title, ...props }) => (react_1.default.createElement(components_1.Flexbox, { ...props, alignItems: "center", backgroundColor: "background-color-01", height: small ? '20rem' : medium ? '30rem' : '40rem', justifyContent: "center", position: "relative" },
...
const styled_system_1 = __webpack_require__(18005);
const getColor_1 = __importDefault(__webpack_require__(73967));
const Button = ({ children, disabled, icon, onClick, size = 'large', type = 'button', variant = 'primary', ...props }) => (react_1.default.createElement(Container, { ...props, disabled: disabled, onClick: onClick, size: size, type: type, variant: variant },
...
const react_1 = __importDefault(__webpack_require__(67294));
const styled_components_1 = __webpack_require__(91288);
const Chevron = ({ clickHandler, right }) => {
    const { colors } = (0, styled_components_1.useTheme)();
...
exports.useBanners = useBanners_1.default;
...
const react_1 = __importDefault(__webpack_require__(67294));
const styled_components_1 = __importDefault(__webpack_require__(91288));
const CheckboxField = ({ field: { name, onBlur, onChange, value }, fieldLabel, id, isFirst, meta: { error, touched }, subtitle, title, val }) => (react_1.default.createElement(react_1.default.Fragment, null,
    ...
    react_1.default.createElement(Container, { backgroundColor: "background-color-01", marginBottom: "m-size", padding: "s-size", position: "relative" },
        react_1.default.createElement(components_1.StyledInput, { checked: id === value, id: id, name: name, onBlur: onBlur, onChange: onChange, type: "radio", value: id }),
...
const components_1 = __webpack_require__(82740);
const react_1 = __importDefault(__webpack_require__(67294));
const FeatureItem = ({ children, subtitle, title }) => (react_1.default.createElement(components_1.Tile, { height: subtitle ? '23.53rem' : '20rem', padding: 0 },
...
const react_1 = __importStar(__webpack_require__(67294));
const styled_components_1 = __importDefault(__webpack_require__(91288));
const ImageLoader = ({ alt = '', objectFit = 'contain', objectPosition, src }) => {
...
const styled_components_1 = __importDefault(__webpack_require__(91288));
const getColor_1 = __importDefault(__webpack_require__(73967));
const Input = ({ disabled, field, label, maxLength, meta, placeholder, type = 'text', ...props }) => {
...
const styled_components_1 = __importDefault(__webpack_require__(91288));
const getColor_1 = __importDefault(__webpack_require__(73967));
const Link = ({ children, icon, ...props }) => (react_1.default.createElement(Container, { ...props },
...
const Container = (0, styled_components_1.default)(components_1.Tile) `
  ...
  ${components_2.ProductImageHover}
`;
...
const styled_components_1 = __importDefault(__webpack_require__(91288));
const MobileInput = ({ disabled, fieldProps, label, placeholder }) => {
...
const components_1 = __webpack_require__(82740);
const react_1 = __importDefault(__webpack_require__(67294));
const ModalContent = ({ children, ...props }) => (react_1.default.createElement(components_1.Flexbox, { ...props, flexDirection: "column", height: "100%", width: "100%" }, children));
...
const components_1 = __webpack_require__(82740);
const react_1 = __importDefault(__webpack_require__(67294));
const ModalHeader = ({ children, onClick }) => (react_1.default.createElement(react_1.default.Fragment, null,
    react_1.default.createElement(components_1.Flexbox, { alignItems: "center", justifyContent: "space-between" },
...
const Modal = ({ children, isOpen, label, setIsOpen }) => (react_1.default.createElement(react_1.default.Fragment, null,
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const styled_components_1 = __webpack_require__(91288);
const ProductImageHover = (0, styled_components_1.css) `
  &:hover {
    img {
      transform: scale(1.1);
    }
...
`;
exports["default"] = ProductImageHover;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const react_1 = __importDefault(__webpack_require__(67294));
function QueryLoader({ Loader, children, query }) {
    if (query.isFetching) {
        if (Loader) {
            return Loader;
        }
...
const components_1 = __webpack_require__(82740);
const react_1 = __importDefault(__webpack_require__(67294));
const SectionHead = ({ link, title, ...props }) => {
    if (!title && !link) {
        return null;
    }
...
const react_1 = __importDefault(__webpack_require__(67294));
const Select = ({ onChange, options, placeholder, value }) => (react_1.default.createElement(react_select_1.default, { onChange: onChange, options: sortAndMapOptions(options), placeholder: placeholder, styles: {
        menu: (provided) => ({
            ...provided,
            zIndex: 10
        })
...
function Table({ columns, data }) {
    const { getTableBodyProps, getTableProps, headerGroups, prepareRow, rows } = (0, react_table_1.useTable)({
        columns,
        data
    });
    return (react_1.default.createElement(Container, null,
...
const react_1 = __importDefault(__webpack_require__(67294));
const styled_components_1 = __importStar(__webpack_require__(91288));
const Text = ({ children, span, type, wrap = true, ...props }) => {
    const { fontSizes, fontWeigths, letterSpacings } = (0, styled_components_1.useTheme)();
    let fontSize, fontWeight, letterSpacing;
    switch (type) {
        case 'subtitle-1':
...
const components_1 = __webpack_require__(82740);
const react_1 = __importDefault(__webpack_require__(67294));
const Tile = ({ children, onClick, ...props }) => (react_1.default.createElement(components_1.Flexbox, { background: "white", border: "1px solid", borderColor: "border-color", flexDirection: "column", onClick: onClick, padding: "l-size", width: "100%", ...props }, children));
...
const react_1 = __importDefault(__webpack_require__(67294));
const react_router_dom_1 = __webpack_require__(77856);
const TitleAndLinkBanner = ({ link: { label, to }, title }) => {
    const history = (0, react_router_dom_1.useHistory)();
    return (react_1.default.createElement(react_1.default.Fragment, null,
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Text = exports.Table = exports.Switch = exports.ResultIcon = exports.ProductImageHover = exports.Modal = exports.MaxWidth = exports.ListItem = exports.Heading = exports.FieldWrapper = exports.FeatureItem = exports.ExternalLink = exports.ContentLoader = exports.Carousel = exports.BannerWithPicture = exports.BackButton = exports.AdminRoute = exports.TitleAndLinkBanner = exports.Link = exports.InputLabel = exports.MobileInput = exports.Logo = exports.Input = exports.Spinner = exports.Banner = exports.Grid = exports.SectionHead = exports.ImageLoader = exports.LongProductTile = exports.Select = exports.Tile = exports.Button = exports.CheckboxField = exports.Square = exports.Separator = exports.Page = exports.Flexbox = exports.QueryLoader = exports.Box = exports.Badge = void 0;
...
var FieldWrapper_1 = __webpack_require__(72402);
...
var ProductImageHover_1 = __webpack_require__(6665);
Object.defineProperty(exports, "ProductImageHover", ({ enumerable: true, get: function () { return __importDefault(ProductImageHover_1).default; } }));
...
__exportStar(__webpack_require__(80603), exports);
__exportStar(__webpack_require__(27433), exports);
__exportStar(__webpack_require__(94561), exports);
...
const EditModal = ({ done, id }) => {
    const { t } = (0, hooks_1.useTranslation)('ADMIN_CALLBACKS');
    const { t: commonT } = (0, hooks_1.useTranslation)('COMMON');
    const [isModalOpen, setIsModalOpen] = (0, react_1.useState)(false);
    const { initialValues, onSubmit, schema, setView, view } = (0, useForm_1.default)(id, done);
    const onClose = () => {
...
const EditModal = ({ id, is_enabled }) => {
    ...
    const { t: commonT } = (0, hooks_1.useTranslation)('COMMON');
    const [isModalOpen, setIsModalOpen] = (0, react_1.useState)(false);
    const { initialValues, onSubmit, schema, setView, view } = (0, useForm_1.default)(id, is_enabled);
    const onClose = () => {
        setIsModalOpen(false);
        setView({ view: 'FORM' });
...
const EditModal = ({ consent, id }) => {
    const { t } = (0, hooks_1.useTranslation)('ADMIN_NEWSLETTER_USERS');
    const { t: commonT } = (0, hooks_1.useTranslation)('COMMON');
    const [isModalOpen, setIsModalOpen] = (0, react_1.useState)(false);
    const { initialValues, onSubmit, schema, setView, view } = (0, useForm_1.default)(id, consent);
    const onClose = () => {
        setIsModalOpen(false);
        setView({ view: 'FORM' });
...
const AppRouter = () => (react_1.default.createElement(react_router_dom_1.Router, { history: exports.history },
    react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(react_router_dom_1.Switch, null,
            ...
            react_1.default.createElement(components_1.AdminRoute, { component: pages_1.AdminPaymentTypes, path: routes_1.ADMIN_PAYMENT_TYPES }),
            ...
            react_1.default.createElement(react_router_dom_1.Route, { component: pages_1.Documents, path: routes_1.DOCUMENTS }),
...
const commonComponents_1 = __webpack_require__(39186);
const App = () => {
    const { auth, setAuth } = (0, react_1.useContext)(providers_1.authContext);
    (0, react_1.useEffect)(() => {
...
const components_1 = __webpack_require__(82740);
const react_1 = __importDefault(__webpack_require__(67294));
const Tile = ({ content, extended, icon, title }) => (react_1.default.createElement(components_1.Tile, { flexDirection: "column", gridColumn: extended ? 'auto / span 2' : 'auto' },
...
const components_1 = __webpack_require__(82740);
const react_1 = __importDefault(__webpack_require__(67294));
const Option = ({ description, icon, title }) => (react_1.default.createElement(components_1.Flexbox, { alignItems: "center", border: "1px solid", borderColor: "border-color", padding: "m-size" },
...
const Loader = () => (react_1.default.createElement(components_1.Flexbox, { flexDirection: "column" },
    ...
    react_1.default.createElement(commonComponents_1.ProductsGridLoader, { count: 6, marginTop: "m-size" })));
...
const Form = ({ product }) => {
    const { getProductFromBasket } = (0, react_1.useContext)(providers_1.basketContext);
    const { initialValues, schema, submitForm } = (0, useForm_1.default)(product);
    const isInBasket = !!getProductFromBasket(product.id);
...
const useForm = (product) => {
    const { getProductFromBasket, setBasket } = (0, react_1.useContext)(providers_1.basketContext);
    const { setCheckout } = (0, react_1.useContext)(providers_2.checkoutContext);
    const initialValues = {};
    const schema = (0, yup_1.object)({
...
const react_1 = __importDefault(__webpack_require__(67294));
const hooks_1 = __webpack_require__(5554);
const OtherIcons = ({ iconId, labelId }) => {
    const { t } = (0, hooks_1.useTranslation)('VIEW_PRODUCT');
...
const react_1 = __importDefault(__webpack_require__(67294));
const hooks_1 = __webpack_require__(5554);
const OtherPlaces = ({ collectionId, labelId }) => {
    const { t } = (0, hooks_1.useTranslation)('VIEW_PRODUCT');
...
const react_1 = __importDefault(__webpack_require__(67294));
const hooks_1 = __webpack_require__(5554);
const SubmitButton = ({ disabled, isInBasket, separation }) => {
    const { t } = (0, hooks_1.useTranslation)('VIEW_PRODUCT');
...
const CheckoutDelivery = () => {
    ...
    (0, hooks_1.useScrollTop)();
    const deliveryTypesQuery = (0, api_1.useGetDeliveryTypes)();
    const { checkout } = (0, react_1.useContext)(providers_1.checkoutContext);
    const { initialValues, onSubmitForm, schema } = (0, useForm_1.default)();
...
const useForm = () => {
    const { t } = (0, hooks_1.useTranslation)('CHECKOUT_DELIVERY');
    const history = (0, react_router_dom_1.useHistory)();
    const { checkout, setCheckout } = (0, react_1.useContext)(providers_1.checkoutContext);
...
const CheckoutDetails = () => {
    ...
    const { getSchema, initialValues, onSubmitForm } = (0, useForm_1.default)();
...
const CheckoutPayment = () => {
    ...
    const paymentTypesQuery = (0, api_1.useGetPaymentTypes)();
    const { checkout } = (0, react_1.useContext)(providers_1.checkoutContext);
    const { initialValues, isLoading, onSubmit, schema } = (0, useForm_1.default)();
...
const useFormSubmit = () => {
    ...
    const { t } = (0, hooks_1.useTranslation)('CHECKOUT_PAYMENT');
    const { checkout, setCheckout } = (0, react_1.useContext)(providers_1.checkoutContext);
    const { setBasket } = (0, react_1.useContext)(providers_2.basketContext);
    const { hide, show } = (0, react_1.useContext)(providers_3.loaderContext);
    const { isLoading, mutateAsync: mutateAddOrderSupabase } = (0, react_query_1.useMutation)(api_1.addOrder);
    const triggerSendEmail = (0, api_1.useTriggerSendEmail)();
    const onSubmit = async (form) => {
        ...
        setCheckout(providers_1.initState);
        setBasket([]);
        hide();
...
const Actions = ({ primaryDisabled }) => {
    ...
    const { basketLength } = (0, react_1.useContext)(providers_1.basketContext);
...
const providers_1 = __webpack_require__(7539);
const lodash_add_1 = __importDefault(__webpack_require__(24427));
const Total = ({ customDelivery, customProducts }) => {
    const { t } = (0, hooks_1.useTranslation)('COMMON');
    const { checkout } = (0, react_1.useContext)(providers_1.checkoutContext);
...
__exportStar(__webpack_require__(27333), exports);
__exportStar(__webpack_require__(74618), exports);
__exportStar(__webpack_require__(62434), exports);
__exportStar(__webpack_require__(8329), exports);
__exportStar(__webpack_require__(59705), exports);
...
const { publicAnonKey, url } = config_1.default;
if (!url) {
...
/******/ })()
;
//# sourceMappingURL=main.376341619e89298e1cc3.js.map