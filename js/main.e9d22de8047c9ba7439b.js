...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.remoteConfig = exports.basketItem = exports.product = void 0;
...
var remoteConfig_1 = __webpack_require__(93038);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const zod_1 = __webpack_require__(78754);
const remoteConfig = (0, zod_1.object)({
    testKey: (0, zod_1.string)().optional()
});
...
const components_1 = __webpack_require__(26789);
const react_1 = __importDefault(__webpack_require__(67294));
const Temp2_1 = __importDefault(__webpack_require__(29987));
const Temp = () => {
    const productsQuery = (0, getProducts_1.useGetProducts)();
    return (react_1.default.createElement(components_1.QueryLoader, { query: productsQuery }, (products) => (react_1.default.createElement("div", null,
        products.length > 0 && (react_1.default.createElement("div", { className: "grid grid-product grid-count-6" },
            react_1.default.createElement("div", { className: "grid-col" }),
            react_1.default.createElement("div", { className: "grid-col" },
                react_1.default.createElement("h5", null, "Name")),
            react_1.default.createElement("div", { className: "grid-col" },
                react_1.default.createElement("h5", null, "Brand")),
            react_1.default.createElement("div", { className: "grid-col" },
                react_1.default.createElement("h5", null, "Price")),
            react_1.default.createElement("div", { className: "grid-col" },
                react_1.default.createElement("h5", null, "Date Added")),
            react_1.default.createElement("div", { className: "grid-col" },
                react_1.default.createElement("h5", null, "Qty")))),
        products.length === 0
            ? new Array(10).fill({}).map((product, index) => (react_1.default.createElement("p", null, "product")
            // <ProductItem
            ...
            : products.map((product) => (react_1.default.createElement(Temp2_1.default, { key: product.id, product: product })))))));
};
    ...
    return (react_1.default.createElement(react_loading_skeleton_1.SkeletonTheme, { color: "#e1e1e1", highlightColor: "#f2f2f2" },
        react_1.default.createElement("div", { className: `item item-products ${!product.id && 'item-loading'}`, ref: productRef },
            react_1.default.createElement("div", { className: "grid grid-count-6" },
                react_1.default.createElement("div", { className: "grid-col item-img-wrapper" },
                    react_1.default.createElement(react_loading_skeleton_1.default, { width: 50, height: 30 })),
                react_1.default.createElement("div", { className: "grid-col" },
                ...
                react_1.default.createElement("div", { className: "grid-col" },
                    react_1.default.createElement("span", null,
                        react_1.default.createElement(react_loading_skeleton_1.default, { width: 30 }))),
                react_1.default.createElement("div", { className: "grid-col" },
                    react_1.default.createElement("span", null,
                        react_1.default.createElement(react_loading_skeleton_1.default, { width: 30 }))),
                react_1.default.createElement("div", { className: "grid-col" },
                    react_1.default.createElement("span", null,
                        react_1.default.createElement(react_loading_skeleton_1.default, { width: 20 })))),
...
const components_1 = __webpack_require__(26789);
const react_1 = __importDefault(__webpack_require__(67294));
const Temp_1 = __importDefault(__webpack_require__(47326));
const AdminOrders = () => (react_1.default.createElement(components_1.Page, null,
    react_1.default.createElement("div", { className: "product-admin-items" },
        react_1.default.createElement(Temp_1.default, null))));
...
const pages_1 = __webpack_require__(23107);
const AdminOrders_1 = __importDefault(__webpack_require__(53470));
...
const AppRouter = () => (react_1.default.createElement(react_router_dom_1.Router, { history: exports.history },
    react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(react_router_dom_1.Switch, null,
            ...
            react_1.default.createElement(react_router_dom_1.Route, { component: AdminOrders_1.default, path: "/gfggffgfg" }),
...
/******/ })()
;
//# sourceMappingURL=main.e9d22de8047c9ba7439b.js.map