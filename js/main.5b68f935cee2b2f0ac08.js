...
const useGetOrders = (status) => {
    return (0, react_query_1.useQuery)(['orders', { status }], () => getOrders(status));
};
...
__exportStar(__webpack_require__(71941), exports);
    ...
    return (react_1.default.createElement(components_1.Flexbox, { alignItems: "center", backgroundColor: "off-white", flexDirection: "column", paddingY: "l-size" },
        react_1.default.createElement(components_1.MaxWidth, { alignItems: "flex-start", flexDirection: "column" },
            ...
            react_1.default.createElement(components_1.Flexbox, { justifyContent: "space-between", marginTop: "l-size", width: "100%" },
                ...
                isAdmin && (react_1.default.createElement(components_1.Flexbox, { alignItems: "flex-start", flexDirection: "column" }, adminLinks_1.default.map((link) => (react_1.default.createElement(components_1.Link, { key: link.to, to: link.to },
...
const useOrderInfo = (order) => {
    ...
    return {
        id: order.id,
        updatedAt: (0, utils_1.displayDate)((0, date_fns_1.parseISO)(order.updated_at)),
        createdAt: (0, utils_1.displayDate)((0, date_fns_1.parseISO)(order.created_at)),
...
const Table = ({ status, columns }) => {
    ...
    return (react_1.default.createElement(components_1.QueryLoader, { query: ordersQuery }, (orders) => {
        return (react_1.default.createElement(components_1.Box, { as: "table", border: "1px solid", borderColor: "border-color", width: "100%" },
...
const sortOrders = (orders) => orders.sort((prev, next) => 
// isBefore()
 true
...
const AdminOrders = () => {
    ...
    return (react_1.default.createElement(components_1.Page, null,
        ...
        react_1.default.createElement(react_tabs_1.Tabs, null,
            react_1.default.createElement(react_tabs_1.TabList, null, orderStatuses_1.default.map((status) => (react_1.default.createElement(react_tabs_1.Tab, { key: status },
                react_1.default.createElement(components_1.Text, { type: "button" }, commonT(`ORDER_STATUSES.${status}`)))))),
            orderStatuses_1.default.map((status) => (react_1.default.createElement(react_tabs_1.TabPanel, { key: status },
...
const DeliveryAndPayments = () => {
    ...
    return (react_1.default.createElement(components_1.Page, null,
        ...
        react_1.default.createElement(components_1.QueryLoader, { query: deliveryTypesQuery }, (deliveryTypes) => (react_1.default.createElement(components_1.Grid, null, deliveryTypes
            ...
            .map((type) => (react_1.default.createElement(components_1.FeatureItem, { key: type.id, subtitle: `${(0, utils_1.displayMoney)(type.price)} - ${type.time}`, title: commonT(`DELIVERY_TYPES.${type.label}`) },
...
const Form = ({ deliveryTypes }) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(common_1.Row, { flexDirection: "column" }, deliveryTypes
            .filter((type) => type.isAvailable)
            .map((type, index) => (react_1.default.createElement(formik_1.Field, { key: type.label, name: "deliveryType" }, (props) => (react_1.default.createElement(components_1.CheckboxField, { ...props, fieldLabel: t('form.deliveryType.label'), id: type.label, isFirst: index === 0, subtitle: `${type.time}`, title: commonT(`DELIVERY_TYPES.${type.label}`), val: (0, utils_1.displayMoney)(type.price) }))))))));
};
exports["default"] = Form;
...
/******/ })()
;
//# sourceMappingURL=main.5b68f935cee2b2f0ac08.js.map