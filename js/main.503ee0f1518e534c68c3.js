...
const getDeliveryTypes = async () => {
    const { data, error } = await supabase_1.default
        .from('delivery_type')
        .select('id, label, price, time, requires_address');
    if (error) {
...
exports["default"] = useGetCollectionProducts;
...
exports["default"] = useGetLabelProducts;
...
exports["default"] = useGetOtherIcons;
...
exports["default"] = useGetOtherPlaces;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.addOrder = exports.useGetCollectionProducts = exports.useGetLabelProducts = exports.useGetOtherIcons = exports.useGetOtherPlaces = exports.useGetProducts = exports.useGetProduct = exports.getMolds = exports.triggerNewOrder = exports.getOrderStatus = exports.updateOrderStatus = exports.getOrders = void 0;
...
Object.defineProperty(exports, "useGetProduct", ({ enumerable: true, get: function () { return __importDefault(getProduct_1).default; } }));
var getProducts_1 = __webpack_require__(78487);
Object.defineProperty(exports, "useGetProducts", ({ enumerable: true, get: function () { return __importDefault(getProducts_1).default; } }));
var getOtherPlaces_1 = __webpack_require__(89983);
Object.defineProperty(exports, "useGetOtherPlaces", ({ enumerable: true, get: function () { return __importDefault(getOtherPlaces_1).default; } }));
var getOtherIcons_1 = __webpack_require__(33924);
Object.defineProperty(exports, "useGetOtherIcons", ({ enumerable: true, get: function () { return __importDefault(getOtherIcons_1).default; } }));
var getLabelProducts_1 = __webpack_require__(49455);
Object.defineProperty(exports, "useGetLabelProducts", ({ enumerable: true, get: function () { return __importDefault(getLabelProducts_1).default; } }));
var getCollectionProducts_1 = __webpack_require__(69501);
Object.defineProperty(exports, "useGetCollectionProducts", ({ enumerable: true, get: function () { return __importDefault(getCollectionProducts_1).default; } }));
...
const Home = () => {
    ...
    (0, hooks_1.useTabTitle)(t('title'));
    (0, hooks_1.useScrollTop)();
    const { mutateAsync: mutateAddOrderSupabase } = (0, react_query_1.useMutation)(api_1.addOrderSupabase);
    return (react_1.default.createElement(components_1.Page, null,
        react_1.default.createElement(components_1.Button, { onClick: () => mutateAddOrderSupabase({
                address: {
                    street: 'StrettValue',
                    streetNo: '5/6',
                    adressCdn: 'adress cnd',
                    postCode: '45-456',
                    city: 'BOdguszcz'
                },
                shipping: {
                ...
                phone: '0 45 45 6 5 43 546',
                email: 'graadlaf6@fm.com',
                deliveryType: 'd5366b84-5941-45d1-a116-1b7870a8e1e5',
                paymentType: '80148c22-1098-4211-a3d0-329c07c26c3a',
                total: 2.0,
                products: [
                    { id: '18294d2d-eb9e-4b23-8be9-9d13c00fe9db', quantity: 2 },
                    { id: 'a7e76bb9-e491-4ea3-a134-4a5b3a6ec917', quantity: 2 },
                    { id: 'ee3a92e8-d3d2-4771-a19c-ed44cf948eef', quantity: 2 }
                ],
...
const CheckoutDelivery = () => {
    ...
    return (react_1.default.createElement(components_1.Page, null,
        ...
        react_1.default.createElement(components_1.QueryLoader, { query: deliveryTypesQuery }, (deliveryTypes) => (react_1.default.createElement(common_1.Wrapper, null,
            react_1.default.createElement(common_1.StepTitle, null, t('title')),
            react_1.default.createElement(formik_1.Formik, { initialValues: initialValues, validateOnChange: true, validationSchema: schema, onSubmit: (values) => onSubmitForm(values, deliveryTypes) }, ({ handleSubmit, values }) => {
...
const Form = ({ isCompany: isCompany }) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(Row_1.default, null,
            react_1.default.createElement(FieldWrapper_1.default, null,
                react_1.default.createElement(formik_1.Field, { name: "addressCdn", type: "text" }, (props) => (react_1.default.createElement(components_1.Input, { ...props, label: (0, utils_1.getRequiredOrNot)(t('form.addressCdn.label'), true), maxLength: 6, placeholder: t('form.addressCdn.placeholder') }))))),
        react_1.default.createElement(Row_1.default, null,
            react_1.default.createElement(FieldWrapper_1.default, null,
...
const CheckoutPayment = () => {
    ...
    return (react_1.default.createElement(components_1.Page, null,
        react_1.default.createElement(common_1.StepTracker, null),
        react_1.default.createElement(components_1.QueryLoader, { query: paymentTypesQuery }, (paymentTypes) => (react_1.default.createElement(common_1.Wrapper, null,
            react_1.default.createElement(common_1.StepTitle, null, t('title')),
...
const Form = () => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(Row_1.default, null,
            react_1.default.createElement(FieldWrapper_1.default, null,
                react_1.default.createElement(formik_1.Field, { name: "addressCdn", type: "text" }, (props) => (react_1.default.createElement(components_1.Input, { ...props, label: getRequiredOrNot(t('form.addressCdn.label'), true), maxLength: 6, placeholder: t('form.addressCdn.placeholder') }))))),
        react_1.default.createElement(Row_1.default, null,
            react_1.default.createElement(FieldWrapper_1.default, null,
...
const Actions = ({ primaryDisabled }) => {
    ...
    return (react_1.default.createElement(Flexbox_1.default, { marginTop: "3rem", alignItems: "center", justifyContent: "space-between" },
        ...
        , { 
            // disabled={isBasketEmpty || primaryDisabled}
            onClick: onClickNext, type: isFirstPage ? 'button' : 'submit' },
...
/******/ })()
;
//# sourceMappingURL=main.503ee0f1518e534c68c3.js.map