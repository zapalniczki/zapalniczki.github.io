...
const Checkout = () => {
    ...
    const { closeBasket } = (0, react_1.useContext)(BasketToggleProvider_1.basketToggleContext);
    return (react_1.default.createElement(components_1.QueryLoader, { query: productsQuery }, (products) => (react_1.default.createElement(components_1.Flexbox, { background: "white", padding: "m-size", alignItems: "center", width: "100%" },
        react_1.default.createElement("div", null,
            react_1.default.createElement("p", { className: "basket-total-title" }, t('basket.total')),
            react_1.default.createElement("h2", { className: "basket-total-amount" }, (0, utils_1.displayMoney)((0, utils_1.calculateTotal)(basket.map((product) => getProductTotal(products, product)))))),
        react_1.default.createElement(Button_1.default, { variant: "secondary", marginLeft: "auto", onClick: () => {
                closeBasket();
                history.push(routes_1.SHOP);
            } }, t('basket.backToShop')),
        react_1.default.createElement(Button_1.default, { marginLeft: "10px", onClick: () => {
                closeBasket();
...
const Basket = () => {
    ...
    return (react_1.default.createElement(Container, { isOpen: isOpen },
        ...
        react_1.default.createElement(components_1.Flexbox, { flexGrow: 1, flexDirection: "column", overflowY: "auto", padding: "s-size" },
            ...
            basket.map((product, index) => (react_1.default.createElement(react_1.Fragment, { key: `${product.id}${product.variant ? `_${product.variant}` : ''}` },
...
const BasketProvider_1 = __importDefault(__webpack_require__(81400));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.displayActionMessage = exports.displayMoney = exports.displayDate = void 0;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.BasketToggleProvider = void 0;
...
/******/ })()
;
//# sourceMappingURL=main.fa79320dfd079b364301.js.map