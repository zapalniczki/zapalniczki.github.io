...
var getMolds_1 = __webpack_require__(28007);
...
// NEWSLETTER
__exportStar(__webpack_require__(74249), exports);
// PRODUCTS
__exportStar(__webpack_require__(78487), exports);
...
const useAddEmail = () => {
    return (0, react_query_1.useMutation)(addEmail);
};
...
var addEmail_1 = __webpack_require__(85615);
Object.defineProperty(exports, "addEmail", ({ enumerable: true, get: function () { return __importDefault(addEmail_1).default; } }));
...
const useGetFeatured = () => {
    return (0, react_query_1.useQuery)('products/featured', () => getFeatured());
};
...
var getFeatured_1 = __webpack_require__(8830);
Object.defineProperty(exports, "getFeatured", ({ enumerable: true, get: function () { return __importDefault(getFeatured_1).default; } }));
__exportStar(__webpack_require__(8830), exports);
...
const Checkout = () => {
    ...
    return (react_1.default.createElement(components_1.QueryLoader, { query: productsQuery }, (products) => {
        ...
        return (react_1.default.createElement(components_1.Flexbox, { background: "white", padding: "m-size", alignItems: "center", width: "100%" },
            ...
            react_1.default.createElement(components_1.Button, { size: "medium", variant: "secondary", marginLeft: "auto", onClick: () => {
                    closeBasket();
                    history.push(routes_1.PRODUCTS);
                } }, t('basket.backToShop')),
            react_1.default.createElement(components_1.Button, { size: "medium", marginLeft: "m-size", onClick: () => {
                    setCheckout((prev) => ({
                        ...prev,
                        totalNew: total,
                        products2: basket
...
const Header = () => {
    ...
    return (react_1.default.createElement(components_1.Flexbox, { padding: "m-size", width: "100%", backgroundColor: "white", 
        ...
        react_1.default.createElement(components_1.Text, { type: "subtitle-1", marginRight: "auto" },
            t('basket.title'),
        ...
        !!basketLength && (react_1.default.createElement(components_1.Button, { marginRight: "s-size", size: "medium", variant: "secondary", onClick: () => {
                clearBasket();
                setCheckout((prev) => ({
                    ...prev,
                    totalNew: 0
        ...
        react_1.default.createElement(components_1.Button, { size: "medium", variant: "secondary", onClick: closeBasket, type: "button" }, t('basket.close'))));
};
...
const SimpleButton = ({ disabled, onClick, children, ...props }) => (react_1.default.createElement(components_1.Box, { ...props },
    react_1.default.createElement(components_1.Button, { size: "medium", variant: "ternary", disabled: disabled, onClick: onClick, type: "button" }, children)));
...
const getColor_1 = __importDefault(__webpack_require__(7518));
const Basket = () => {
    const { t } = (0, hooks_1.useTranslation)('COMMON');
...
const Footer = () => {
    ...
    return (react_1.default.createElement(components_1.Flexbox, { alignItems: "center", backgroundColor: "off-white", flexDirection: "column", paddingY: "l-size" },
        react_1.default.createElement(components_1.MaxWidth, { alignItems: "flex-start", flexDirection: "column" },
            ...
            react_1.default.createElement(components_1.Flexbox, { alignItems: "flex-start", flexDirection: "column", marginTop: "l-size" }, links.map((link) => (react_1.default.createElement(components_1.Link, { key: link.to, to: link.to },
            ...
            react_1.default.createElement(components_1.Flexbox, { justifyContent: "space-between", width: "100%" },
                ...
                react_1.default.createElement(components_1.Link, { to: Routes.DOCUMENTS },
...
const Form = () => {
    ...
    return (react_1.default.createElement(components_1.Flexbox, { alignItems: "flex-end" },
        ...
        react_1.default.createElement(components_1.Button, { size: "small", marginLeft: "m-size", type: "submit" }, commonT('NEWSLETTER.FORM.FORM.SUBMIT.label'))));
};
...
const react_1 = __importDefault(__webpack_require__(67294));
const hooks_1 = __webpack_require__(92457);
const Form_1 = __importDefault(__webpack_require__(56895));
const useForm_1 = __importDefault(__webpack_require__(68074));
const formik_1 = __webpack_require__(94649);
const Newsletter = () => {
    const { t: commonT } = (0, hooks_1.useTranslation)('COMMON');
    ...
    let content = (react_1.default.createElement(formik_1.Formik, { initialValues: initialValues, validateOnChange: true, validationSchema: schema, onSubmit: onSubmit }, ({ handleSubmit }) => (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(formik_1.Form, { style: { width: '100%' }, onSubmit: handleSubmit },
    ...
    return (react_1.default.createElement(components_1.Banner, { marginTop: "xxl-size", horizonal: true, medium: true },
        react_1.default.createElement(components_1.Flexbox, { justifyContent: "flex-start", flexDirection: "column", width: "100%", height: "100%" },
            react_1.default.createElement(components_1.Heading, { level: 4 }, title),
            react_1.default.createElement(components_1.Text, { marginBottom: "m-size", type: "body-2" }, subtitle),
            content)));
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const addEmail_1 = __webpack_require__(85615);
const hooks_1 = __webpack_require__(92457);
const LoaderProvider_1 = __webpack_require__(30150);
const react_1 = __webpack_require__(67294);
...
const useForm = () => {
    ...
    const { mutateAsync: mutateAddEmail } = (0, addEmail_1.useAddEmail)();
...
const react_1 = __importDefault(__webpack_require__(67294));
const components_1 = __webpack_require__(26789);
const TileLoader = () => (react_1.default.createElement(components_1.ContentLoader, { gradientRatio: 1, width: 380, height: 300, viewBox: "0 0 380 300" },
    react_1.default.createElement("rect", { width: "380", height: "300" })));
...
const ProductTile_1 = __importDefault(__webpack_require__(11977));
const ProductsList = ({ loaderCount, searchQuery, link, title, query, vertical, ...props }) => {
    return (react_1.default.createElement(components_1.QueryLoader, { Loader: react_1.default.createElement(index_loader_1.default, { count: loaderCount, title: !!title || !!link }), query: query }, (products) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Newsletter = exports.ReadPrivacyPolicy = exports.ReadTermsAndConditions = exports.Features = exports.ProductsGrid = exports.Footer = exports.Basket = exports.Navigation = exports.Preloader = void 0;
...
var Newsletter_1 = __webpack_require__(24867);
...
const Banner = ({ small, medium, description, title, children, background, horizonal, ...props }) => (react_1.default.createElement(components_1.Flexbox, { ...props, position: "relative", height: small ? '20rem' : medium ? '30rem' : '40rem', backgroundColor: "background-color-01", justifyContent: "center", alignItems: "center" },
...
const react_1 = __importDefault(__webpack_require__(67294));
const styled_components_1 = __importDefault(__webpack_require__(91288));
const Indicator = ({ clickHandler, isSelected }) => (react_1.default.createElement(Container, { as: "button", border: "none", marginRight: "xxs-size", width: "2.5rem", height: "0.5rem", backgroundColor: isSelected ? 'braty-red' : 'white', disabled: isSelected, onClick: clickHandler }));
...
const Box_1 = __importDefault(__webpack_require__(84962));
const useBanners_1 = __importDefault(__webpack_require__(66573));
const Indicator_1 = __importDefault(__webpack_require__(2564));
const Carousel = ({ children }) => {
    const { getBanner } = (0, useBanners_1.default)();
    const multipleChildren = children.length > 1;
    return (react_1.default.createElement(Box_1.default, { width: "100%", height: "100%" },
        react_1.default.createElement(react_responsive_carousel_1.Carousel, { autoPlay: true, interval: 7000, dynamicHeight: false, infiniteLoop: true, showStatus: false, showThumbs: false, showArrows: !!multipleChildren, showIndicators: true, renderIndicator: (clickHandler, isSelected, index, label) => (react_1.default.createElement(Indicator_1.default, { clickHandler: clickHandler, isSelected: isSelected, index: index, label: label })) }, children.map((child, index) => (react_1.default.createElement(react_1.Fragment, { key: index }, getBanner(child)))))));
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const BannerWithPicture_1 = __importDefault(__webpack_require__(29205));
const Button_1 = __importDefault(__webpack_require__(91362));
const Heading_1 = __importDefault(__webpack_require__(4567));
const routes_1 = __webpack_require__(74897);
const react_1 = __importDefault(__webpack_require__(67294));
const hooks_1 = __webpack_require__(92457);
const react_router_dom_1 = __webpack_require__(77856);
...
const getBanners = (t, history) => ({
    YOUR_PLACE: (react_1.default.createElement(BannerWithPicture_1.default, { bannerKey: "YOUR_PLACE", description: t('banner.description'), title: react_1.default.createElement(Heading_1.default, { textAlign: "center", level: 3 },
            react_1.default.createElement("strong", null, "Twoje"),
            "\u00A0miejsce w\u00A0",
            react_1.default.createElement("strong", null, "Twoim"),
            "\u00A0punkcie") },
        react_1.default.createElement(Button_1.default, { size: "medium", onClick: () => history.push(routes_1.PRODUCTS), icon: "arrow-right" }, t('banner.buttonLabel'))))
});
...
const ContentLoader = ({ children, ...props }) => (react_1.default.createElement(components_1.Box, { width: `${props.width}px`, height: `${props.height}px` },
    react_1.default.createElement(react_content_loader_1.default, { speed: 2, ...props },
        children,
        react_1.default.createElement("rect", { x: "0", y: "0", rx: "0", ry: "0", width: "200", height: "200" }))));
...
const ExternalLink = ({ children, to }) => {
    return (react_1.default.createElement(Container, { href: to, rel: "noopener noreferrer", target: "_blank" }, children));
};
...
const Heading = ({ children, level, ...props }) => {
    ...
    return (react_1.default.createElement(components_1.Box, { as: `h${level}`, margin: "0", fontSize: fontSize, fontWeight: fontWeight, letterSpacing: letterSpacing, color: "heading-color", ...props }, children));
};
...
const ListItem = ({ children, ...props }) => {
    return (react_1.default.createElement(Container, { ...props },
        ...
        react_1.default.createElement(Heading_1.default, { level: 6, marginLeft: "m-size" }, children)));
};
...
`;
const Container = (0, styled_components_1.default)(Flexbox_1.default) `
  list-style-type: none;
  align-items: center;
`;
...
const react_1 = __importDefault(__webpack_require__(67294));
const styled_components_1 = __importDefault(__webpack_require__(91288));
const ProductTile_1 = __webpack_require__(11977);
const getColor_1 = __importDefault(__webpack_require__(7518));
const LongProductTile = ({ product, ...props }) => {
    ...
    return (react_1.default.createElement(Container, { as: react_router_dom_1.Link, to: `/view_product/${product.id}`, ...props },
        react_1.default.createElement(Heading_1.default, { level: 6, marginLeft: "m-size" }, product.name),
...
const Text = ({ wrap = true, span, children, type, ...props }) => {
    ...
    return (react_1.default.createElement(Container, { as: span ? 'span' : 'p', margin: 0, fontSize: fontSize, fontWeight: fontWeight, letterSpacing: letterSpacing, color: props.white ? 'white' : 'black', wrap: wrap, ...props }, children));
};
const Container = (0, styled_components_1.default)(components_1.Box) `
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.MaxWidth = exports.ListItem = exports.Carousel = exports.BannerWithPicture = exports.BackButton = exports.FeatureItem = exports.Heading = exports.Text = exports.ContentLoader = exports.ExternalLink = exports.TitleAndLinkBanner = exports.Link = exports.InputLabel = exports.MobileInput = exports.Logo = exports.Input = exports.Spinner = exports.Banner = exports.Grid = exports.SectionHead = exports.ImageLoader = exports.LongProductTile = exports.Select = exports.Tile = exports.Button = exports.CheckboxField = exports.Square = exports.Separator = exports.Page = exports.Flexbox = exports.QueryLoader = exports.Box = exports.Badge = void 0;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.DOCUMENTS = exports.HOW_TO_CREATE_ORDER = exports.CONTACT = exports.DELIVERY_AND_PAYMENTS = exports.ADMIN_ORDERS = exports.CHECKOUT_RESULT = exports.CHECKOUT_PAYMENT = exports.CHECKOUT_SHIPPING = exports.CHECKOUT_DELIVERY = exports.CHECKOUT_DETAILS = exports.CHECKOUT_PRODUCTS = exports.VIEW_PRODUCT = exports.PRODUCTS = exports.HOME = void 0;
exports.HOME = '/';
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.useTranslation = exports.useTabTitle = exports.useScrollTop = exports.useSchema = exports.useDocumentTitle = void 0;
...
var useSchema_1 = __webpack_require__(80692);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const yup_1 = __webpack_require__(87561);
const useTranslation_1 = __importDefault(__webpack_require__(74806));
const useSchema = () => {
...
const getMolds_1 = __webpack_require__(28007);
...
const pages_1 = __webpack_require__(23107);
const Documents_1 = __importDefault(__webpack_require__(82505));
...
const auth_1 = __webpack_require__(62756);
...
const react_1 = __importDefault(__webpack_require__(67294));
const hooks_1 = __webpack_require__(92457);
const _1 = __webpack_require__(17124);
...
const Form = () => {
    ...
    return (react_1.default.createElement(_1.ViewWrapper, { alignItems: "flex-end" },
        ...
        react_1.default.createElement(components_1.Button, { variant: "secondary", size: "small", marginLeft: "m-size", type: "submit" }, t('items.CHECK_STATUS.form.submit.label'))));
};
exports["default"] = Form;
...
const Result = ({ status, setView }) => {
    ...
    return (react_1.default.createElement(_1.ViewWrapper, { flexDirection: "column" },
        react_1.default.createElement(components_1.Text, { type: "body-2" },
            ...
            ' ',
            react_1.default.createElement("strong", null, commonT(`orderStatuses.${status}`))),
        react_1.default.createElement(components_1.Text, { type: "caption" }, t(`items.CHECK_STATUS.result.statusesMeanings.${status}`)),
        react_1.default.createElement(components_1.Button, { variant: "secondary", marginTop: "m-size", size: "small", onClick: () => setView({ view: 'FORM' }) }, t('items.CHECK_STATUS.result.tryNew'))));
};
...
const CheckStatus = () => {
    ...
    if (view.view === 'RESULT') {
        ...
        content = react_1.default.createElement(Error_1.default, { setView: setView, message: view.message });
    }
    else {
        content = (react_1.default.createElement(formik_1.Formik, { initialValues: initialValues, validateOnChange: true, validationSchema: schema, onSubmit: onSubmit }, ({ handleSubmit }) => (react_1.default.createElement(formik_1.Form, { style: { width: '100%' }, onSubmit: handleSubmit },
            react_1.default.createElement(Form_1.default, null)))));
    }
    return (react_1.default.createElement(components_1.Flexbox, { justifyContent: "space-between" },
        content,
        react_1.default.createElement(components_1.Flexbox, { marginLeft: "xxxl-size", alignItems: "center", justifyContent: "center" },
            react_1.default.createElement(react_fontawesome_1.FontAwesomeIcon, { icon: "box", size: "4x" }))));
};
...
const hooks_1 = __webpack_require__(92457);
const react_1 = __importDefault(__webpack_require__(67294));
const hooks_2 = __webpack_require__(92457);
const Tile_1 = __importDefault(__webpack_require__(25018));
const useContactMethod_1 = __importDefault(__webpack_require__(40661));
const Contact = () => {
...
const react_1 = __importDefault(__webpack_require__(67294));
const hooks_2 = __webpack_require__(92457);
const ListItem_1 = __importDefault(__webpack_require__(42956));
const Documents = () => {
    ...
    return (react_1.default.createElement(components_1.Page, null,
        react_1.default.createElement(components_1.Banner, { horizonal: true, small: true, title: react_1.default.createElement(components_1.Heading, { level: 4 }, t('title')) }),
        react_1.default.createElement(ListItem_1.default, { marginTop: "l-size" },
            react_1.default.createElement(components_2.ExternalLink, { to: "https://drive.google.com/file/d/1csQd4cWoBWJh26xaFo-ZWasBoZPk-8FK/view?usp=sharing" }, t('TYPES.termsAndConditions'))),
        react_1.default.createElement(ListItem_1.default, { marginTop: "l-size" },
            react_1.default.createElement(components_2.ExternalLink, { to: "https://drive.google.com/file/d/1csQd4cWoBWJh26xaFo-ZWasBoZPk-8FK/view?usp=sharing" }, t('TYPES.privacyPolicy')))));
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const products_1 = __webpack_require__(7327);
const commonComponents_1 = __webpack_require__(31802);
const hooks_1 = __webpack_require__(92457);
const react_1 = __importDefault(__webpack_require__(67294));
const Featured = () => {
    const { t: commonT } = (0, hooks_1.useTranslation)('HOME');
    const featuredQuery = (0, products_1.useGetFeatured)();
...
const commonComponents_1 = __webpack_require__(31802);
const Featured_1 = __importDefault(__webpack_require__(96244));
const Home = () => {
...
const api_1 = __webpack_require__(72934);
const index_loader_1 = __importDefault(__webpack_require__(66964));
const Products = () => {
    ...
    return (react_1.default.createElement(components_1.Page, null,
        react_1.default.createElement(components_1.QueryLoader, { Loader: react_1.default.createElement(index_loader_1.default, null), query: productsQuery }, (data) => {
            ...
            return (react_1.default.createElement(react_1.default.Fragment, null,
                isFiltered && (react_1.default.createElement(components_1.BackButton, { label: t('showAllLabel'), to: routes_1.PRODUCTS })),
                !isFiltered && (react_1.default.createElement(components_1.Flexbox, { alignItems: "center", flexDirection: "row-reverse", justifyContent: "space-between" },
...
const Loader = () => {
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(components_1.ContentLoader, { width: 1200, height: 44, viewBox: "0 0 1200 44" },
            react_1.default.createElement("rect", { width: "55", height: "24", transform: "translate(0,10)" })),
...
const index_loader_1 = __importDefault(__webpack_require__(89054));
const ViewProduct = () => {
...
const CheckoutDetails = () => {
    ...
    return (react_1.default.createElement(components_1.Page, null,
        ...
        react_1.default.createElement(common_1.Wrapper, null,
            react_1.default.createElement(common_1.StepTitle, null, t('title')),
            react_1.default.createElement(components_1.Flexbox, { marginTop: "m-size", marginBottom: "m-size", justifyContent: "center", alignItems: "center" },
...
const Actions = ({ primaryDisabled }) => {
    ...
    return (react_1.default.createElement(components_1.Flexbox, { marginTop: "3rem", alignItems: "center", justifyContent: "space-between" },
        react_1.default.createElement(components_1.Button, { size: "medium", variant: "secondary", onClick: onClickPrevious, type: "button" }, t(isFirstPage ? 'checkoutActions.backToShop' : 'checkoutActions.back')),
        react_1.default.createElement(components_1.Button, { size: "medium", disabled: isBasketEmpty || primaryDisabled, onClick: onClickNext, type: isFirstPage ? 'button' : 'submit', icon: "arrow-right" },
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Documents = exports.HowToCreateOrder = exports.DeliveryAndPayments = exports.Contact = exports.Home = exports.AdminOrders = exports.CheckoutResult = exports.CheckoutShipping = exports.CheckoutPayment = exports.CheckoutDelivery = exports.CheckoutDetails = exports.CheckoutProducts = exports.ViewProduct = exports.PageNotFound = exports.App = exports.Products = void 0;
...
var Documents_1 = __webpack_require__(82505);
...
.control-arrow {
  ...
  ::before {
    border-right-color:${(0, getColor_1.default)('braty-red')} !important;
    border-left-color:${(0, getColor_1.default)('braty-red')} !important;
  }
}
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("32cdcbaf1ab650b76214")
/******/ 	})();
/******/ 	
...
/******/ 		}
/******/ 		
/******/ 		self["webpackHotUpdateecommerce_react"] = (chunkId, moreModules, runtime) => {
...
/******/ })()
;
//# sourceMappingURL=main.116b6cd479eb9ffb7e6f.js.map