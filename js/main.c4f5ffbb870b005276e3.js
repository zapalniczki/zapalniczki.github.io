...
exports.getProductsSelect = 'id, price, name, label_id, icon_id, collection_id, mainImage:image(tile)';
...
const ProductTile = ({ product }) => {
    ...
    return (react_1.default.createElement(Container, { to: viewProductPath, as: react_router_dom_1.Link, "max-height": "30rem" },
        ...
        react_1.default.createElement(components_1.Flexbox, { backgroundColor: "background-color", justifyContent: "space-between", padding: "m-size", width: "100%" },
            ...
            isInBasket && (react_1.default.createElement(components_1.Flexbox, { justifyContent: "center", alignItems: "center" },
                react_1.default.createElement(react_fontawesome_1.FontAwesomeIcon, { size: "1x", icon: "shopping-basket" }),
                react_1.default.createElement(components_1.Box, { marginLeft: "xxs-size" },
                    react_1.default.createElement(react_fontawesome_1.FontAwesomeIcon, { size: "1x", color: colors.green, icon: "check" })))))));
};
const Container = (0, styled_components_1.default)(components_1.Tile) `
  color: unset;
  cursor: pointer;
...
const Loader = ({ count = 3, ...props }) => (react_1.default.createElement(components_1.Grid, { ...props }, [...Array(count).keys()].map((n) => (react_1.default.createElement(TIle_loader_1.default, { key: n })))));
...
const ProductsList = ({ searchQuery, link, title, query, ...props }) => {
    return (react_1.default.createElement(components_1.Flexbox, { flexDirection: "column", as: "section", ...props },
        ...
        react_1.default.createElement(components_1.QueryLoader, { Loader: react_1.default.createElement(index_loader_1.default, null), query: query }, (products) => (react_1.default.createElement(components_1.Grid, null, products
            ...
            .map((product) => (react_1.default.createElement(ProductTile_1.default, { key: product.id, product: product }))))))));
};
...
const Button = ({ variant = 'primary', disabled, onClick, children, type = 'button', size = 'large', icon, ...props }) => (react_1.default.createElement(Container, { ...props, size: size, variant: variant, disabled: disabled, onClick: onClick, type: type },
    children && (react_1.default.createElement(components_1.Text, { wrap: false, white: variant === 'primary', type: "button" }, children)),
...
const LongProductTile = ({ product, ...props }) => {
    const history = (0, react_router_dom_1.useHistory)();
    const imageUrl = product.mainImage.tile;
...
const SectionHead = ({ title, link, ...props }) => {
    ...
    return (react_1.default.createElement(components_1.Flexbox, { marginBottom: "m-size", justifyContent: "space-between", alignItems: "center", ...props },
...
const hooks_2 = __webpack_require__(92457);
const PrivacyPolicy = () => {
    const { t } = (0, hooks_2.useTranslation)('PRIVACY_POLICY');
    (0, hooks_1.useTabTitle)(t('title'));
    (0, hooks_1.useScrollTop)();
    return (react_1.default.createElement(components_1.Page, null,
...
const Search = ({ value, onChange }) => {
    ...
    return (react_1.default.createElement(components_1.Flexbox, { width: "25rem" },
        ...
        react_1.default.createElement(components_1.Button, { marginLeft: "m-size", size: "medium", variant: "ternary", onClick: () => onChange(''), icon: value ? 'times' : 'search' })));
};
...
const Loader = () => (react_1.default.createElement(components_1.Flexbox, { flexDirection: "column" },
    react_1.default.createElement(components_1.ContentLoader, { width: 1200, height: 40, viewBox: "0 0 1200 40" },
        react_1.default.createElement("rect", { width: "80", height: "24", transform: "translate(0,8)" }),
        react_1.default.createElement("rect", { width: "188", height: "40", transform: "translate(950,0)" }),
        react_1.default.createElement("rect", { width: "46", height: "40", transform: "translate(1154,0)" })),
    ...
    return (react_1.default.createElement(components_1.Page, null,
        react_1.default.createElement(components_1.QueryLoader, { Loader: react_1.default.createElement(index_loader_1.default, null), query: productsQuery }, (data) => {
            ...
            return (react_1.default.createElement(react_1.default.Fragment, null,
                ...
                react_1.default.createElement(commonComponents_1.ProductsGrid, { marginTop: "m-size", searchQuery: query, query: productsQuery })));
        })));
};
...
const TermsAndConditions = () => {
    const { t } = (0, hooks_2.useTranslation)('TERMS_AND_CONDITIONS');
    (0, hooks_1.useScrollTop)();
    (0, hooks_1.useTabTitle)(t('title'));
    return (react_1.default.createElement(components_1.Page, null,
        react_1.default.createElement(components_1.Banner, { small: true, title: react_1.default.createElement("h1", null, t('title')) }),
...
const Images = ({ product }) => {
    ...
    return (react_1.default.createElement(components_1.Flexbox, { flexGrow: 4, flexDirection: "column", minWidth: width, maxWidth: width },
        react_1.default.createElement(components_1.Flexbox, { display: "flex" },
            react_1.default.createElement(components_1.Flexbox, { flexDirection: "column", width: "6rem", height: "100%" }, [mainImage.thumbnail].map((image) => (react_1.default.createElement(GalleryImageWrapper, { key: image, onClick: () => setSelectedImage(image), role: "presentation" },
...
const SubmitButton = ({ separation, disabled, isInBasket }) => {
    const { t } = (0, hooks_1.useTranslation)('VIEW_PRODUCT');
    return (react_1.default.createElement(components_1.Button, { marginTop: separation ? '2rem' : 0, type: "submit", disabled: disabled, variant: isInBasket ? 'secondary' : 'primary', size: "medium" }, isInBasket ? t('actions.removeFromBasket') : t('actions.addToBasket')));
};
...
.control-arrow {
  ...
  ::before {
    border-right-color:${(props) => props.theme.colors['braty-red']} !important;
    border-left-color:${(props) => props.theme.colors['braty-red']} !important;
  }
}
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("c36e553a92f56733757d")
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=main.c4f5ffbb870b005276e3.js.map