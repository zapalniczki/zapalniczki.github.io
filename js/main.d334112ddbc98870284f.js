...
const getProducts = async (payload) => {
    ...
    if (payload?.label) {
        q = (0, firestore_1.query)(ref, (0, firestore_1.where)('label', '==', payload.label));
    }
    if (payload?.label && payload?.icon && payload.otherVariants) {
        q = (0, firestore_1.query)(ref, (0, firestore_1.where)('label', '==', payload.label), (0, firestore_1.where)('icon', '!=', payload.icon));
    }
    if (payload?.label && payload?.icon && payload.otherVariants) {
        q = (0, firestore_1.query)(ref, (0, firestore_1.where)('label', '==', payload.label), (0, firestore_1.where)('icon', '!=', payload.icon));
    }
    if (payload?.label && payload?.collection && payload.otherVariants) {
        q = (0, firestore_1.query)(ref, (0, firestore_1.where)('collection', '==', payload.collection), (0, firestore_1.where)('label', '!=', payload.label), (0, firestore_1.limit)(3));
    }
    const snapshot = await (0, firestore_1.getDocs)(q);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CITIES = exports.COLLECTIONS = exports.ICONS = exports.DELIVERY_METHODS = exports.PAYMENT_METHODS = void 0;
...
exports.ICONS = ['HEART', 'BOAT', 'ANCHOR', 'FLAG'];
exports.COLLECTIONS = ['PLACES', 'POLAND'];
exports.CITIES = [
    {
        value: 'sopot',
        label: 'Sopot'
...
const icon = (0, zod_1.enum)([...config_1.ICONS]);
const label = (0, zod_1.string)();
const collection = (0, zod_1.enum)([...config_1.COLLECTIONS]);
...
const Search = ({ value, onChange }) => {
    ...
    return (react_1.default.createElement(components_1.Flexbox, { position: "relative", width: "35%" },
...
const Products = () => {
    ...
    const isFiltered = state?.label || state?.collection;
    return (react_1.default.createElement(components_1.Page, null,
...
const Images = ({ product, variant }) => {
    ...
    return (react_1.default.createElement(components_1.Flexbox, { flexGrow: 4, flexDirection: "column", minWidth: width, maxWidth: width },
        react_1.default.createElement(components_1.Flexbox, { display: "flex" },
            gallery.length > 1 && (react_1.default.createElement(components_1.Flexbox, { flexDirection: "column", width: "6rem", height: "100%" }, gallery.map((image) => (react_1.default.createElement(GalleryImageWrapper, { key: image.id, onClick: () => setSelectedImage(image.url), role: "presentation" },
...
const Info = ({ product, setVariant }) => {
    ...
    return (react_1.default.createElement(components_1.Flexbox, { flexGrow: 1, flexDirection: "column", marginLeft: "xl-size" },
        ...
        react_1.default.createElement(components_1.Flexbox, { marginTop: "xxs-size" },
            ...
            react_1.default.createElement(components_1.Box, { as: "h4", marginY: 0, marginLeft: "s-size" }, config_1.CITIES.find((city) => city.value === product.label)?.label)),
        react_1.default.createElement(components_1.Flexbox, { marginTop: "xxs-size" },
            react_1.default.createElement(components_1.Box, { color: "gray-10", as: "h4", margin: 0 }, t('icon')),
            react_1.default.createElement(components_1.Box, { as: "h4", marginY: 0, marginLeft: "s-size" }, commonT(`icons.${product.icon}`))),
        react_1.default.createElement(components_1.Separator, null),
...
const react_1 = __importDefault(__webpack_require__(67294));
const react_i18next_1 = __webpack_require__(26828);
const OtherPlaces = ({ label, collection }) => {
    const { t } = (0, react_i18next_1.useTranslation)('VIEW_PRODUCT');
    const productsQuery = (0, getProducts_1.useGetProducts)({
        label,
        collection,
        ...
        react_1.default.createElement(components_1.QueryLoader, { query: productQuery }, (product) => {
            return (react_1.default.createElement(react_1.default.Fragment, null,
                ...
                react_1.default.createElement(components_1.Tile, { flexDirection: "row" },
                    ...
                    react_1.default.createElement(Info_1.default, { setVariant: setVariant, product: product }))));
        }),
        productQuery.isFetched && productQuery.data?.collection === 'PLACES' && (react_1.default.createElement(OtherIcons_1.default, { label: productQuery.data?.label, icon: productQuery.data?.icon })),
        productQuery.isFetched && productQuery.data?.collection === 'PLACES' && (react_1.default.createElement(OtherPlaces_1.default, { label: productQuery.data?.label, collection: productQuery.data.collection }))));
};
...
/******/ })()
;
//# sourceMappingURL=main.d334112ddbc98870284f.js.map