...
const Square_1 = __importDefault(__webpack_require__(75681));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const getProducts_1 = __importDefault(__webpack_require__(78487));
...
const react_query_1 = __webpack_require__(88767);
const react_router_dom_1 = __webpack_require__(77856);
const useBasketClickToggle_1 = __importDefault(__webpack_require__(639));
const Checkout = () => {
    const { t } = (0, react_i18next_1.useTranslation)();
    const { pathname } = (0, react_router_dom_1.useLocation)();
    const history = (0, react_router_dom_1.useHistory)();
    const { basket } = (0, react_1.useContext)(basketProvider_1.basketContext);
    const productsQuery = (0, react_query_1.useQuery)('productsQuery', () => (0, getProducts_1.default)());
    ...
    return (react_1.default.createElement(QueryLoader_1.default, { query: productsQuery }, (products) => (react_1.default.createElement(Flexbox_1.default, { background: "white", padding: "m-size", alignItems: "center", width: "100%" },
        react_1.default.createElement("div", null,
            react_1.default.createElement("p", { className: "basket-total-title" }, t('common.basket.total')),
            react_1.default.createElement("h2", { className: "basket-total-amount" }, (0, utils_1.displayMoney)((0, utils_1.calculateTotal)(basket.map((product) => {
                const productPrice = products.find((elem) => elem.id === product.id)?.price ||
                    0;
...
const react_i18next_1 = __webpack_require__(86162);
const Flexbox_1 = __importDefault(__webpack_require__(16827));
const Separator_1 = __importDefault(__webpack_require__(89854));
const basketProvider_1 = __webpack_require__(69507);
const styled_components_1 = __importDefault(__webpack_require__(91288));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Basket = exports.Navigation = exports.Preloader = void 0;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Square = exports.Flexbox = exports.Separator = exports.Badge = exports.QueryLoader = exports.Box = exports.Page = void 0;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.VIEW_PRODUCT = exports.PRODUCTS = void 0;
...
const getProduct = async (payload) => {
    ...
    const ref = (0, firestore_1.doc)(firestore, 'products', payload.id);
    const response = await (0, firestore_1.getDoc)(ref);
    const parsedResponse = (0, parseApiResponse_1.default)(product, response);
    return parsedResponse;
};
exports.default = getProduct;
...
const pages_1 = __webpack_require__(23107);
const PageNotFound_1 = __importDefault(__webpack_require__(13700));
const ViewProduct_1 = __importDefault(__webpack_require__(54097));
...
const AppRouter = () => (react_1.default.createElement(react_router_dom_1.Router, { history: exports.history },
    react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(react_router_dom_1.Switch, null,
            ...
            react_1.default.createElement(react_router_dom_1.Route, { component: ViewProduct_1.default, path: routes_1.VIEW_PRODUCT }),
...
const Form = ({ product, onSelect }) => {
    ...
    return (react_1.default.createElement(formik_1.Formik, { initialValues: initialValues, validateOnChange: true, validationSchema: schema, onSubmit: submitForm }, () => (react_1.default.createElement(formik_1.Form, null,
        product.variants && (react_1.default.createElement(formik_1.Field, { name: "email", type: "email" }, (fieldProps) => (react_1.default.createElement("div", null,
            react_1.default.createElement("span", { className: "text-subtle" }, product.variantsLabel),
            react_1.default.createElement("br", null),
            react_1.default.createElement("br", null),
        ...
        react_1.default.createElement("div", { className: "product-modal-action" },
            react_1.default.createElement("button", { disabled: product.variants && !variant, className: `button button-small ${isInBasket ? 'button-border button-border-gray' : ''}`, onClick: handleAddProductToBasket, type: "button" }, isInBasket ? t('removeFromBasket') : t('addToBasket')))))));
};
...
const Images = ({ product, variant }) => {
    ...
    return (react_1.default.createElement(components_1.Flexbox, { flexGrow: 4, flexDirection: "column", minWidth: "40%", maxWidth: "500px" },
...
const ViewProduct = () => {
    ...
    return (react_1.default.createElement(components_1.Page, null,
        react_1.default.createElement(components_1.QueryLoader, { query: productQuery }, (data) => (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(BackButton_1.default, null),
            react_1.default.createElement(ProductModal, null,
                react_1.default.createElement(Images_1.default, { variant: variant, product: data }),
                react_1.default.createElement(components_1.Flexbox, { flexGrow: 1, flexDirection: "column", marginLeft: "3rem" },
                    ...
                    react_1.default.createElement("span", { style: { width: '100%' } }, data.description),
                    react_1.default.createElement("br", null),
                    react_1.default.createElement("br", null),
                    react_1.default.createElement(components_1.Separator, null),
                    react_1.default.createElement(Form_1.default, { onSelect: onSelect, product: data }))))))));
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ViewProduct = exports.PageNotFound = exports.App = exports.Products = void 0;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getCollection = exports.parseApiResponse = void 0;
...
/******/ })()
;
//# sourceMappingURL=main.63ea42d700389adec385.js.map