...
const components_1 = __webpack_require__(26789);
const react_1 = __importDefault(__webpack_require__(67294));
const Grid_1 = __importDefault(__webpack_require__(17364));
const ProductsList = ({ title, query }) => (react_1.default.createElement(components_1.QueryLoader, { query: query }, (data) => (react_1.default.createElement(components_1.Flexbox, { flexDirection: "column", as: "section", marginTop: "4rem" },
    react_1.default.createElement(components_1.SectionHead, { title: title }),
    react_1.default.createElement(Grid_1.default, { products: data })))));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SectionHead = exports.ImageLoader = exports.LongProductTile = exports.Select = exports.Tile = exports.Button = exports.CheckboxField = exports.Square = exports.Flexbox = exports.Separator = exports.Badge = exports.QueryLoader = exports.Box = exports.Page = void 0;
...
const Home = () => {
    ...
    return (react_1.default.createElement(components_1.Page, null,
        ...
        react_1.default.createElement(components_1.QueryLoader, { query: productsQuery }, (products) => (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            products.map((product, index) => (react_1.default.createElement(components_1.LongProductTile, { key: product.id, product: product, marginTop: index === 0 ? 0 : '3rem' }))))))));
};
...
/******/ })()
;
//# sourceMappingURL=main.282b1e07a039c0ead332.js.map