...
const useGetProducts = (payload) => {
    ...
    if (payload?.tag) {
        queryKey = `products/${payload.tag}`;
    }
    if (payload?.title) {
        queryKey = `products/${payload.title}`;
    }
    if (payload?.icon && payload?.title) {
        queryKey = `products/${payload.title}/${payload.icon}`;
    }
...
const ProductsList = ({ title, query, ...props }) => (react_1.default.createElement(components_1.Flexbox, { flexDirection: "column", as: "section", ...props },
    react_1.default.createElement(components_1.SectionHead, { title: title }),
    react_1.default.createElement(components_1.QueryLoader, { query: query }, (products) => (react_1.default.createElement(components_1.Grid, null, products.map((product) => (react_1.default.createElement(Tile_1.default, { key: product.id, product: product }))))))));
...
const icon = (0, zod_1.enum)(['HEART', 'BOAT', 'ANCHOR']);
...
const MakeOrderSteps = () => {
    return (react_1.default.createElement(components_1.Tile, { marginTop: "xxl-size" },
        react_1.default.createElement(components_1.Box, { minHeight: "50rem" })));
};
exports["default"] = MakeOrderSteps;
...
const hooks_1 = __webpack_require__(92457);
const react_1 = __importDefault(__webpack_require__(67294));
const MakeOrderSteps_1 = __importDefault(__webpack_require__(93509));
const HowToCreateOrder = () => {
    ...
    return (react_1.default.createElement(components_1.Page, null,
        ...
        react_1.default.createElement(MakeOrderSteps_1.default, null),
        react_1.default.createElement(commonComponents_1.ReadTermsAndConditions, null),
...
const BackButton = () => {
    ...
    return (react_1.default.createElement(components_1.Box, { marginY: "m-size" },
        react_1.default.createElement(components_1.Link, { to: routes_1.PRODUCTS },
            react_1.default.createElement(react_fontawesome_1.FontAwesomeIcon, { icon: "arrow-left" }),
            react_1.default.createElement(components_1.Box, { as: "h3", marginY: 0, marginLeft: "s-size" }, t('actions.goBack')))));
};
...
const OtherIcons = ({ title, icon }) => {
    ...
    return (react_1.default.createElement(commonComponents_1.ProductsGrid, { marginTop: "xxl-size", title: t('otherIcons.title'), query: productsQuery }));
};
        ...
        react_1.default.createElement(components_1.QueryLoader, { query: productQuery }, (product) => {
            ...
            return (react_1.default.createElement(react_1.default.Fragment, null,
                ...
                react_1.default.createElement(components_1.Tile, { flexDirection: "row" },
                    ...
                    react_1.default.createElement(components_1.Flexbox, { flexGrow: 1, flexDirection: "column", marginLeft: "l-size" },
...
/******/ })()
;
//# sourceMappingURL=main.18df2e677a8698bf5fa4.js.map