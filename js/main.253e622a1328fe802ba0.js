...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.updateOrderStatus = exports.getOrders = exports.addOrder = exports.getProduct = exports.getProducts = void 0;
...
const Footer = () => {
    const { pathname } = (0, react_router_dom_1.useLocation)();
    const visibleOnlyPath = [routes_1.HOME, routes_1.PRODUCTS, routes_1.VIEW_PRODUCT];
...
const ProductsList = ({ title, query }) => (react_1.default.createElement(components_1.QueryLoader, { query: query }, (products) => (react_1.default.createElement(components_1.Flexbox, { flexDirection: "column", as: "section", marginTop: "4rem" },
...
const styleProps = (0, styled_system_1.compose)(styled_system_1.layout, styled_system_1.space, styled_system_1.position, styled_system_1.flex, styled_system_1.grid, styled_system_1.border, styled_system_1.flexbox, styled_system_1.background, styled_system_1.color);
...
const react_1 = __importDefault(__webpack_require__(67294));
const Grid = ({ children }) => (react_1.default.createElement(Box_1.default, { display: "grid", gridTemplateColumns: "repeat(auto-fit, 38rem)", gridGap: GRID_GAP }, children));
const GRID_GAP = '3rem';
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Grid = exports.SectionHead = exports.ImageLoader = exports.LongProductTile = exports.Select = exports.Tile = exports.Button = exports.CheckboxField = exports.Square = exports.Flexbox = exports.Separator = exports.Badge = exports.QueryLoader = exports.Box = exports.Page = void 0;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ADMIN_ORDERS = exports.CHECKOUT_RESULT = exports.CHECKOUT_PAYMENT = exports.CHECKOUT_SHIPPING = exports.CHECKOUT_DELIVERY = exports.CHECKOUT_DETAILS = exports.CHECKOUT_PRODUCTS = exports.VIEW_PRODUCT = exports.PRODUCTS = exports.HOME = void 0;
exports.HOME = '/';
...
fontawesome_svg_core_1.library.add(free_solid_svg_icons_1.faTruck, free_solid_svg_icons_1.faUserClock, free_solid_svg_icons_1.faExchangeAlt, free_solid_svg_icons_1.faStar, free_solid_svg_icons_1.faBoxOpen, free_solid_svg_icons_1.faHandHoldingUsd);
...
const AdminOrders = () => {
    ...
    return (react_1.default.createElement(components_1.Page, null, orderStatuses_1.default.map((status, index) => (react_1.default.createElement(components_1.Tile, { key: status, marginTop: index === 0 ? 0 : '3rem' },
        react_1.default.createElement("h2", null, t(`statuses.${status}`)),
...
const Home = () => {
    ...
    return (react_1.default.createElement(components_1.Page, null,
        react_1.default.createElement(Banner_1.default, { img: banner_guy_png_1.default, description: t('banner.description'), title: react_1.default.createElement("h1", { className: "text-thin" },
        ...
        react_1.default.createElement(components_1.Grid, null, features.map((feature) => (react_1.default.createElement(FeatureItem_1.default, { icon: feature.icon, title: t(`features.items.${feature.key}`) })))),
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Home = exports.AdminOrders = exports.CheckoutResult = exports.CheckoutShipping = exports.CheckoutPayment = exports.CheckoutDelivery = exports.CheckoutDetails = exports.CheckoutProducts = exports.ViewProduct = exports.PageNotFound = exports.App = exports.Products = void 0;
...
/******/ })()
;
//# sourceMappingURL=main.253e622a1328fe802ba0.js.map