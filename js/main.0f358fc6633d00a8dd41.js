...
const react_1 = __importDefault(__webpack_require__(67294));
const styled_components_1 = __importDefault(__webpack_require__(91288));
const Indicator = ({ clickHandler, isSelected }) => (react_1.default.createElement(Container, { as: "button", border: "none", marginRight: "xxs-size", width: "5rem", height: "1rem", backgroundColor: isSelected ? 'braty-red' : 'white', disabled: isSelected, onClick: clickHandler }));
...
const react_1 = __importDefault(__webpack_require__(67294));
const styled_components_1 = __webpack_require__(91288);
const Text = ({ span, children, type, ...props }) => {
    const { fontSizes, fontWeigths, letterSpacings } = (0, styled_components_1.useTheme)();
    let fontSize, fontWeight, letterSpacing;
    switch (type) {
        case 'subtitle-1':
    ...
    return (react_1.default.createElement(components_1.Box, { as: span ? 'span' : 'p', margin: 0, fontSize: fontSize, fontWeight: fontWeight, letterSpacing: letterSpacing, color: props.white ? 'white' : 'black', ...props }, children));
};
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("7fc7363a7872daa7127f")
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=main.0f358fc6633d00a8dd41.js.map