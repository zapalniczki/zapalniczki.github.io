...
const Chevron = ({ right, clickHandler }) => {
    ...
    return (react_1.default.createElement(components_1.Flexbox, { alignItems: "center", height: "100%", left: !right ? 0 : 'unset', position: "absolute", right: right ? 0 : 'unset', top: "0", zIndex: 5 },
        react_1.default.createElement(components_1.Button, { onClick: clickHandler, variant: "quaternary" },
            react_1.default.createElement(react_fontawesome_1.FontAwesomeIcon, { color: colors['braty-red'], icon: right ? 'chevron-right' : 'chevron-left', size: "2x" }))));
};
...
const Chevron_1 = __importDefault(__webpack_require__(1485));
const Carousel = ({ children }) => {
    const { getBanner } = (0, useBanners_1.default)();
    const multipleChildren = children.length > 1;
    return (react_1.default.createElement(Box_1.default, { height: "100%", width: "100%" },
...
const getBanners = (t, history) => ({
    YOUR_PLACE: (react_1.default.createElement(BannerWithPicture_1.default, { bannerKey: "YOUR_PLACE", description: t('banner.description'), title: react_1.default.createElement(Heading_1.default, { level: 3, textAlign: "center" },
            react_1.default.createElement("strong", null, "Twoje"),
            "\u00A0miejsce w\u00A0",
            react_1.default.createElement("strong", null, "Twoim"),
            "\u00A0punkcie") },
        react_1.default.createElement(Button_1.default, { icon: "arrow-right", onClick: () => history.push(routes_1.PRODUCTS), size: "medium" }, t('banner.buttonLabel'))))
});
...
const CheckStatus = () => {
    ...
    return (react_1.default.createElement(components_1.Flexbox, { justifyContent: "space-between" },
        ...
        react_1.default.createElement(components_1.Flexbox, { alignItems: "center", justifyContent: "center", marginLeft: "xxxl-size" },
            react_1.default.createElement(react_fontawesome_1.FontAwesomeIcon, { color: colors['braty-red'], icon: "box-open", size: "4x" }))));
};
...
const Documents = () => {
    ...
    return (react_1.default.createElement(components_1.Page, null,
        ...
        react_1.default.createElement(ListItem_1.default, { marginTop: "l-size" },
            react_1.default.createElement(components_2.ExternalLink, { to: "https://drive.google.com/file/d/1csQd4cWoBWJh26xaFo-ZWasBoZPk-8FK/view?usp=sharing" }, t('TYPES.cookiesPolicy')))));
};
    ...
    return (react_1.default.createElement(components_1.Page, null,
        ...
        react_1.default.createElement(common_1.Wrapper, null,
            ...
            react_1.default.createElement(components_1.Flexbox, { alignItems: "center", justifyContent: "center", marginBottom: "m-size", marginTop: "m-size" },
                ...
                react_1.default.createElement(react_switch_1.default, { checked: !isCompany, checkedIcon: false, offColor: "#e1e1e1", onChange: (checked) => setIsCompany(!checked), onColor: "#e1e1e1", uncheckedIcon: false }),
...
const Form = ({ paymentTypes }) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(common_1.Row, { flexDirection: "column" }, paymentTypes.map((type, index) => (react_1.default.createElement(formik_1.Field, { key: type.label, name: "paymentType" }, (props) => (react_1.default.createElement(components_1.CheckboxField, { ...props, fieldLabel: t('form.paymentType.label'), id: type.id, isFirst: index === 0, subtitle: commonT(`paymentTypes.${type.label}.subtitle`), title: commonT(`paymentTypes.${type.label}.title`) }))))))));
};
exports["default"] = Form;
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("2370a3522e50b5b52718")
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=main.51dc55f20378f9e025e4.js.map