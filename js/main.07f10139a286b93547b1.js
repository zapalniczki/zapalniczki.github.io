...
const BannerWithPicture = ({ children, ...props }) => (react_1.default.createElement(_1.default, { leftChildren: children, ...props },
    react_1.default.createElement(ImageWrapper, null, bannerTemp)));
const ImageWrapper = styled_components_1.default.div `
  position: relative;
  width: 100%;
  height: 100%;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.BannerWithPicture = void 0;
const react_1 = __importDefault(__webpack_require__(67294));
const styled_components_1 = __importDefault(__webpack_require__(91288));
const components_1 = __webpack_require__(26789);
const BannerWithPicture_1 = __importDefault(__webpack_require__(57048));
exports.BannerWithPicture = BannerWithPicture_1.default;
const Banner = ({ small, description, title, children, leftChildren, ...props }) => (react_1.default.createElement(components_1.Flexbox, { ...props, position: "relative", height: small ? '20rem' : '40rem', backgroundColor: "background-color-01" },
...
//   justify-content: center;
//   flex-direction: column;
//   padding: ${(props) => props.theme.space['xl-size']};
...
const TitleAndLinkBanner = ({ title, link: { to, label } }) => {
    const history = (0, react_router_dom_1.useHistory)();
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(components_1.Banner, { marginTop: "xxl-size", small: true, title: react_1.default.createElement(components_1.Heading, { level: 5 }, title) },
...
__exportStar(__webpack_require__(77308), exports);
...
const HowToCreateOrder = () => {
    ...
    (0, hooks_1.useTabTitle)(t('title'));
    return (react_1.default.createElement(components_1.Page, null,
        react_1.default.createElement(components_1.Banner, { small: true, title: react_1.default.createElement(components_1.Heading, { level: 4 }, t('title')) }),
...
/******/ })()
;
//# sourceMappingURL=main.07f10139a286b93547b1.js.map